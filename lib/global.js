...
module.exports = {
    ...
    getEmbedCode: function(gallery) {
        ...
        embed += 'data-height="100%" ';
        embed += 'data-cycle="false">';
        embed += '<p>' + gallery.caption + '</p>'
        embed += '&mdash; '+ attribution + '. ';
        embed += '<a href="https://fresconews.com/gallery/' + gallery._id + '">' + moment(gallery.time_created).format('MMMM Do, YYYY') + '</a>';
        embed += '</blockquote>';
        
        embed += '<script src="/js/handlers/embed.js" type="text/javascript" async></script>';
