...
module.exports = {
    ...
    /**
     * Attaches an image error handler to refresh the image on a fibbonacci sequence
     */
    attachOnImageLoadError: function(img, size){
    ...
    formatTime: function(timestamp) {
        ...
        if (typeof(window) === 'undefined' || !window.timeFormat || window.timeFormat == 'relative') {
