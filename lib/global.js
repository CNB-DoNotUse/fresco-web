...
module.exports = {
    ...
    permissions: {
        ...
        UPDATE_OTHER_CONTENT: 'update-other-content',
        DELETE_OTHER_CONTENT: 'delete-other-content',
        DISPATCH_ENABLED: 'dispatch-enabled',
        VIEW_ALL_ASSIGNMENTS: 'view-all-assignments',
        CREATE_STORY: 'create-story',
        DELETE_STORY: 'delete-story',
        UPDATE_STORY: 'update-story',
        CREATE_RECAP: 'create-recap',
        DELETE_RECAP: 'delete-recap',
        UPDATE_RECAP: 'update-recap',
        CREATE_ASSIGNMENT: 'create-assignment',
        DELETE_ASSIGNMENT: 'delete-assignment',
        EXPIRE_ASSIGNMENT: 'expire-assignment',
        UPDATE_ASSIGNMENT: 'update-assignmnet',
        GET_ALL_PURCHASES: 'get-all-purchases',
    },
    ...
    setTimeDisplayType: function(timeFormat) {
        ...
        for (var i = timeStrings.length - 1; i >= 0; i--) {
            var timestamp = timeStrings[i].dataset.timestamp;
