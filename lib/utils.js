...
const utils = {
    ...
    getBylineFromGallery(gallery) {
        ...
        if (gallery.external_account_name) 
            return gallery.external_account_name;
        else if (gallery.owner) {
            if (gallery.owner.full_name) 
                return gallery.owner.full_name;
            else if (gallery.owner.username) 
                return gallery.owner.username;
        }
