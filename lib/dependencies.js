...
module.exports = {
	...
	public: {
		...
		index: {
			css: [
				'./public/vendor/slick-carousel/slick/slick.scss',
				'./public/vendor/slick-carousel/slick/slick-theme.scss',
				'./public/vendor/Waves/src/waves.scss',
	...
	platform: {
		...
		galleries: {
			css: [
				'./app/sass/platform/_galleries.scss'
			],
			js: []
		},
