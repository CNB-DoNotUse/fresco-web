 		...
 		$.post('/api/assignment/update', {
			expiration_time: Date.now(),
 			...
 			if(response.err || !response.data){
 				$.snackbar({ content : utils.resolveError(response.err, 'There was an error expiring this assignment!') });
 			} else{
 		...
 		return (
 			<App user={this.props.user}>
 				<TopBar
 					...
 					verifiedToggle={this.props.user.rank >= utils.RANKS.CONTENT_MANAGER} /* Based on user rank to see verified content */
 					editable={true}
