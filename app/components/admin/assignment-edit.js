...
class AdminAssignmentEdit extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        ...
        if (this.props.assignment.id !== assignment.id) {
            ...
            this.refs['assignment-expiration'].value = assignment
                ? global.hoursToExpiration(assignment.expiration_time)
                : null;
    ...
    onRadiusUpdate(radius) {
        this.setState({ radius: global.feetToMiles(radius) });
    }
    ...
    render() {
        ...
        const expiration_time = assignment ? global.hoursToExpiration(assignment.expiration_time) : null;
