...
class SideBarListItems extends React.Component {
	...
	render() {
		...
		if (this.props.user.outlet || this.props.user.rank >= 1){ //CONTENT_MANAGER
			var dispatch = 
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/dispatch')}>
		...
		if (this.props.user.outlet != null){
			...
			var outlet = 
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/outlet')}>
		...
		if(this.props.user.rank >= 2) { 
			...
			var admin = 
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/admin')}>
					<span className="mdi mdi-dots-horizontal icon"></span>Admin
				</li>;
			
			var purchases =  
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/purchases')}>
		...
		return(
			...
			<ul className="md-type-body1">
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/highlights')}>
					<span className="mdi mdi-star icon"></span>Highlights
				</li>
				<li className="sidebar-tab" onClick={this.goLink.bind(null, '/content')}>
					<span className="mdi mdi-play-box-outline icon"></span>All content
				</li>
				<ul>
					<li className="sidebar-tab" onClick={this.goLink.bind(null, '/content/photos')}>
						<span className="mdi mdi-file-image-box icon"></span>Photos
					</li>
					<li className="sidebar-tab" onClick={this.goLink.bind(null, '/content/videos')}>
						<span className="mdi mdi-movie icon"></span>Videos
					</li>
					<li className="sidebar-tab" onClick={this.goLink.bind(null, '/content/galleries')}>
						<span className="mdi mdi-image-filter icon"></span>Galleries
					</li>
					<li className="sidebar-tab" onClick={this.goLink.bind(null, '/content/stories')}>
