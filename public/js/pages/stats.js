...
/***/ function(module, exports, __webpack_require__) {
	...
	var Stats = function (_React$Component) {
	    ...
	    function Stats(props) {
	        ...
	        _this.downloadStats = _this.downloadStats.bind(_this);
	        _this.calculateUsers = _this.calculateUsers.bind(_this);
	        _this.polygonChanged = _this.polygonChanged.bind(_this);
	        _this.placeChanged = _this.placeChanged.bind(_this);
	        _this.kmlClicked = _this.kmlClicked.bind(_this);
	        _this.kmlFileInputChange = _this.kmlFileInputChange.bind(_this);
	        return _this;
	    }
	    ...
	    _createClass(Stats, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            var map = new google.maps.Map(document.getElementById('stat-map'), mapOptions);
	            ...
	            var polyCoords = [{ lat: 40.91525559999999, lng: -73.7002721 }, { lat: 40.4960439, lng: -73.7002721 }, { lat: 40.496043, lng: -74.2557349 }];
	            ...
	            this.setState({ polygon: polygon, map: map, autocomplete: autocomplete });
	        }
	        ...
	        key: 'kmlFileInputChange',
	        value: function kmlFileInputChange() {
	            var file = this.refs.kmlFileInput.files[0];
	            var reader = new FileReader();
	            var _state = this.state;
	            var map = _state.map;
	            var polygon = _state.polygon;
	            ...
	            reader.onload = function () {
	                ...
	                try {
	                    pointArray = kml.getElementsByTagName("Polygon")[0].getElementsByTagName("outerBoundaryIs")[0].getElementsByTagName("coordinates")[0].innerHTML.split(" ");
	                } catch (e) {
	                    return $.snackbar({ content: 'There was an error reading this file!' });
	                }

	                //Map into coordinates array by parsing string
	                var coordinates = pointArray.map(function (str) {
	            ...
	            function handleCoordinates(coordinates) {
	                ...
	                var latLngArray = coordinates.map(function (latLng) {
	        ...
	        key: 'placeChanged',
	        value: function placeChanged(event) {
	            var place = this.state.autocomplete.getPlace();
	            var _state2 = this.state;
	            var map = _state2.map;
	            var polygon = _state2.polygon;
	            ...
	            var locationPolygon = _global2.default.generatePolygonFromBounds(bounds)[0];
	            var latLngArray = [new google.maps.LatLng(bounds.getNorthEast().lat(), bounds.getNorthEast().lng()), new google.maps.LatLng(bounds.getNorthEast().lat(), bounds.getNorthEast().lng()), new google.maps.LatLng(bounds.getSouthWest().lat(), bounds.getNorthEast().lng()), new google.maps.LatLng(bounds.getSouthWest().lat(), bounds.getSouthWest().lng()), new google.maps.LatLng(bounds.getNorthEast().lat(), bounds.getSouthWest().lng()), new google.maps.LatLng(bounds.getNorthEast().lat(), bounds.getNorthEast().lng())];
	        ...
	        key: 'polygonChanged',
	        value: function polygonChanged(event) {
	            ...
	            var firstCoordinate = vertices.getAt(0);
	        ...
	        key: 'calculateUsers',
	        value: function calculateUsers(locations) {
	            var self = this;
	            var day = 86400000;
	            var timeKeys = Object.keys(this.state.counts);
	            var times = [Date.now() - day, //day
	            ...
	            var query = '';
	            var counts = _lodash2.default.clone(this.state.counts);
	            ...
	            for (var _i = 0; _i < timeKeys.length; _i++) {
	                var newQuery = query;

	                if (times[_i] !== null) {
	                    newQuery += '&since=' + times[_i];
	                }
	                ...
	                $.ajax({
	                    ...
	                    success: function success(response, status, xhr) {
	                        ...
	                        if (!response.data || response.err) {
	                            $.snackbar({ content: _global2.default.resolveError(response.err) });
	                        } else {
	                    ...
	                    error: function error(xhr, status, _error) {
	                        return $.snackbar({ content: _global2.default.resolveError(_error) });
	                    }
	                });
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'container-fluid stats' },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'map-wrap' },
	                        _react2.default.createElement(
	                            'h3',
	                            null,
	                            'Drag the polygon to calculate the number of users in an area or use the autocomplete.'
	                        ),
	                        _react2.default.createElement('input', { type: 'text', ref: 'stats-autocomplete', placeholder: 'Enter a location' }),
	                        _react2.default.createElement(
	                            'button',
	                            {
	                                className: 'btn btn-flat pull-right mt12 mr16 kml',
	                                onClick: this.kmlClicked },
	                            'Upload a KML file'
	                        ),
	                        _react2.default.createElement('input', {
	                            ...
	                            accept: 'text/kml',
	                            ref: 'kmlFileInput' }),
	                        _react2.default.createElement('div', { id: 'stat-map', className: 'map' })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'info-wrap' },
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        'Active (location in the last 24 hours)'
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.day ? counts.day.active : null
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.day ? counts.day.total : null
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    'tr',
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.week ? counts.week.active : null
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.week ? counts.week.total : null
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    'tr',
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.week2 ? counts.week2.active : null
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.week2 ? counts.week2.total : null
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    'tr',
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.month ? counts.month.active : null
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.month ? counts.month.total : null
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    'tr',
	                                    ...
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.year ? counts.year.active : null
	                                    ),
	                                    _react2.default.createElement(
	                                        'td',
	                                        null,
	                                        counts.year ? counts.year.total : null
	                                    )
	                                ),
	                                _react2.default.createElement(
	                                    'tr',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { className: 'btn btn-flat pull-right mt12 mr16', onClick: this.downloadStats },
