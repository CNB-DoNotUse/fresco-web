...
/***/ function(module, exports, __webpack_require__) {
	...
	var _topbarAdmin = __webpack_require__(280);

	var _topbarAdmin2 = _interopRequireDefault(_topbarAdmin);

	var _adminBody = __webpack_require__(282);

	var _adminBody2 = _interopRequireDefault(_adminBody);
	...
	*/
	...
	var Admin = function (_React$Component) {
		...
		function Admin(props) {
			...
			_this.clearXHR = _this.clearXHR.bind(_this);

			_this.setTab = _this.setTab.bind(_this);

			_this.getChangedData = _this.getChangedData.bind(_this);

			_this.getData = _this.getData.bind(_this);

			_this.resetAssignments = _this.resetAssignments.bind(_this);
			_this.resetSubmissions = _this.resetSubmissions.bind(_this);
			_this.resetImports = _this.resetImports.bind(_this);

			_this.spliceGallery = _this.spliceGallery.bind(_this);
	   ...
	   */
			...
			key: 'getChangedData',
			value: function getChangedData(newGalleries, currentGalleries) {
				var newIDs = newGalleries.map(function (n) {
					return n._id;
				}),
				    curIDs = currentGalleries.map(function (c) {
					return c._id;
				});
	   ...
	   */
			...
			value: function loadInitial() {
				...
				this.getData(undefined, { tab: 'assignments' }, function (assignments) {

					activeTab = 'assignments';

					_this3.setState({
						assignments: _this3.state.assignments.concat(assignments)
					});
				});

				this.getData(undefined, { tab: 'submissions' }, function (submissions) {

					activeTab = 'submissions';

					_this3.setState({
						submissions: _this3.state.submissions.concat(submissions)
					});
				});

				this.getData(undefined, { tab: 'imports' }, function (imports) {
					_this3.setState({
						activeTab: imports.length ? 'imports' : activeTab,
						imports: _this3.state.imports.concat(imports)
					});
				});
			}
		}, {
			key: 'spliceGallery',
			value: function spliceGallery(data, cb) {

				var stateData = this.state[data.type],
				    index = 0;
			...
			value: function refresh() {
				this.getData(undefined, { unshift: true, tab: this.state.activeTab }, function (data) {});
			}
		}, {
			key: 'getData',
			value: function getData(last, options, cb) {
				var _this4 = this;
				...
				var self = this,
				    ...
				    endpoint = '',
				    params = {},
				    tab = options.tab || this.state.activeTab,
				    newState = {};
				...
				this.currentXHR = $.get(endpoint, params, function (data) {
					if (!data.data) {
						return cb([]);
					}

					var stateData = _this4.state[tab];

					if (!stateData.length) {
						var _newState = {};
						_newState[tab] = data.data;
						if (unshift) {
					...
					var newData = _this4.getChangedData(stateData.concat(data.data), stateData);
					...
					if (concat || unshift) {
						...
						if (unshift) {
							...
							(_stateData = stateData).unshift.apply(_stateData, _toConsumableArray(newData));
						}
			...
			value: function resetAssignments() {
				var _this5 = this;

				this.getData(undefined, { tab: 'assignments' }, function (assignments) {
					_this5.setState({
						activeTab: 'assignments',
						assignments: assignments.length ? assignments : _this5.state.assignments
					});
				});
			}
		}, {
			key: 'resetSubmissions',
			value: function resetSubmissions() {
				var _this6 = this;

				this.getData(undefined, { tab: 'submissions' }, function (submissions) {
					_this6.setState({
						activeTab: 'submissions',
						submissions: submissions.length ? submissions : _this6.state.submissions
					});
				});
			}
		}, {
			key: 'resetImports',
			value: function resetImports() {
				var _this7 = this;

				this.getData(undefined, { tab: 'imports' }, function (imports) {
					_this7.setState({
						activeTab: 'imports',
						imports: imports.length ? imports : _this7.state.imports
					});
				});
			}
		}, {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_topbarAdmin2.default, {
						activeTab: this.state.activeTab,
						resetImports: this.resetImports,
						setTab: this.setTab }),
					_react2.default.createElement(_adminBody2.default, {
						activeTab: this.state.activeTab,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopBarAdmin = function (_React$Component) {
		_inherits(TopBarAdmin, _React$Component);

		function TopBarAdmin(props) {
			_classCallCheck(this, TopBarAdmin);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(TopBarAdmin).call(this, props));

			_this.state = {
				importRunning: false
			};
			_this.setTab = _this.setTab.bind(_this);
			_this.clickImportFileUpload = _this.clickImportFileUpload.bind(_this);
			_this.importFiles = _this.importFiles.bind(_this);
			_this.handleTwitterInputKeyDown = _this.handleTwitterInputKeyDown.bind(_this);
			return _this;
		}

		_createClass(TopBarAdmin, [{
			key: 'setTab',
			value: function setTab(e) {
			...
			key: 'clickImportFileUpload',
			value: function clickImportFileUpload(e) {
				this.refs.uploadImportFiles.click();
			}
		}, {
			key: 'importFiles',
			value: function importFiles(e) {
				var _this2 = this;

				// Probably shouldn't be happening here, but whatevs.
				...
				data.append('caption', 'Gallery imported from local system on ' + (0, _moment2.default)().format('MMMM Do YYYY, h:mm:ss a'));
				...
				$.ajax({
					...
					success: function success(result, status, xhr) {
						...
						_this2.refs.uploadImportFiles.value = '';
						_this2.props.setTab('imports');
						_this2.props.resetImports();
					},
			...
			key: 'handleTwitterInputKeyDown',
			value: function handleTwitterInputKeyDown(e) {
				var _this3 = this;
				...
				$.ajax({
					...
					success: function success(result, status, xhr) {
						if (result.err) {
							return $.snackbar({ content: _global2.default.resolveError(result.err) });
						}

						$.snackbar({ content: 'Gallery Imported!' });
						_this3.refs['twitter-import-input'].value = '';
						_this3.props.setTab('imports');
						_this3.props.resetImports();
					},
					error: function error(xhr, status, _error2) {
						$.snackbar({ content: 'Failed to import media' });
					},
					complete: function complete(exhr, status, error) {
						_this3.importRunning = false;
					}
				});
			}
		}, {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ type: 'button', className: 'icon-button hidden-xs upload-import', onClick: this.clickImportFileUpload },
						_react2.default.createElement('span', { className: 'mdi mdi-upload icon' })
					),
					_react2.default.createElement(
						'div',
					...
					_react2.default.createElement(
						'div',
						{ className: 'tab-control admin-tabs' },
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-flat tab-admin', 'data-tab': 'assignments', onClick: this.setTab },
							'Assignments'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-flat tab-admin', 'data-tab': 'submissions', onClick: this.setTab },
							'Submissions'
						),
						_react2.default.createElement(
							'button',
							{ className: 'btn btn-flat tab-admin', 'data-tab': 'imports', onClick: this.setTab },
							'Imports'
						)
					),
					_react2.default.createElement(
						'li',
						{ className: 'drop no-border pull-right hidden-xs', style: { display: 'none' } },
						_react2.default.createElement(
							'button',
							{ className: 'toggle-drop md-type-subhead' },
							_react2.default.createElement('span', { className: 'mdi mdi-settings icon' }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminGalleryListItem = __webpack_require__(283);

	var _adminGalleryListItem2 = _interopRequireDefault(_adminGalleryListItem);

	var _adminAssignmentListItem = __webpack_require__(284);

	var _adminAssignmentListItem2 = _interopRequireDefault(_adminAssignmentListItem);

	var _adminGalleryEdit = __webpack_require__(285);

	var _adminGalleryEdit2 = _interopRequireDefault(_adminGalleryEdit);

	var _adminAssignmentEdit = __webpack_require__(318);

	var _adminAssignmentEdit2 = _interopRequireDefault(_adminAssignmentEdit);
	...
	var AdminBody = function (_React$Component) {
		...
		function AdminBody(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AdminBody).call(this, props));
			...
			_this.setActiveAssignment = _this.setActiveAssignment.bind(_this);
			_this.setActiveGallery = _this.setActiveGallery.bind(_this);
		...
		_createClass(AdminBody, [{
			...
			value: function componentDidUpdate(prevProps, prevState) {
				...
				function setFirstGalleryActive() {
					...
					var activeField = galleryType == 'assignment' ? 'activeAssignment' : 'activeGallery';
			...
			value: function setActiveAssignment(id) {
			...
			key: 'setActiveGallery',
			value: function setActiveGallery(id, type) {
			...
			key: 'spliceGallery',
			value: function spliceGallery(cb) {
				var _this2 = this;

				var propGalleryType = this.state.activeGalleryType + 's';

				this.props.spliceGallery({ type: propGalleryType, gallery: this.state.activeGallery._id }, function (err, nextGallery) {

					if (_this2.props[propGalleryType].length) {
						_this2.setActiveGallery(_this2.props[propGalleryType][nextGallery]._id, _this2.state.activeGalleryType);
					}
			...
			value: function remove(cb) {
				...
				$.ajax({
					...
					dataType: 'json',
					success: function success(result, status, xhr) {
						_this3.spliceGallery(function () {
							cb(null, _this3.state.activeGallery._id);
						});
					},
					error: function error(xhr, status, _error) {
						cb(_error);
			...
			value: function skip(cb) {
				...
				$.ajax({
					...
					dataType: 'json',
					success: function success(result, status, xhr) {
						_this4.spliceGallery(function () {
							cb(null, _this4.state.activeGallery._id);
						});
					},
					error: function error(xhr, status, _error2) {
						cb(_error2);
			...
			key: 'verify',
			value: function verify(options, cb) {
				var _this5 = this;
			...
			value: function scroll(e) {
				...
				if (target.scrollTop == target.scrollHeight - target.offsetHeight) {
					...
					this.props.getData(items[items.length - 1]._id, { concat: true, tab: this.state.activeGalleryType + 's' }, function (data) {});
				}
			}
		}, {
			key: 'render',
			value: function render() {
				...
				switch (this.props.activeTab) {
					...
					case 'assignments':
						...
						var listItems = this.props.assignments.sort(sortListItem).map(function (assignment, i) {
							return _react2.default.createElement(_adminAssignmentListItem2.default, {
								type: 'assignment',
								assignment: assignment,
								key: i,
								active: _this6.state.activeAssignment._id == assignment._id,
								setActiveAssignment: _this6.setActiveAssignment });
						});

						if (this.state.activeAssignment && this.state.activeAssignment._id) {
							var editPane = _react2.default.createElement(_adminAssignmentEdit2.default, {
					...
					case 'submissions':
						...
						var listItems = this.props.submissions.sort(sortListItem).map(function (submission, i) {
							return _react2.default.createElement(_adminGalleryListItem2.default, {
								type: 'submission',
								gallery: submission,
								key: i,
								active: _this6.state.activeGallery._id == submission._id,
								setActiveGallery: _this6.setActiveGallery });
						});

						var editPane = _react2.default.createElement(_adminGalleryEdit2.default, {
							hasActiveGallery: this.state.hasActiveGallery,
							activeGalleryType: this.state.activeGalleryType,
					...
					case 'imports':
						...
						var listItems = this.props.imports.sort(sortListItem).map(function (gallery, i) {
							return _react2.default.createElement(_adminGalleryListItem2.default, {
								type: 'import',
								gallery: gallery,
								key: i,
								active: _this6.state.activeGallery._id == gallery._id,
								setActiveGallery: _this6.setActiveGallery });
						});
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-md-6 col-lg-7 list', onScroll: this.scroll },
						listItems
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-md-6 col-lg-5 form-group-default admin-edit-pane' },
						editPane
					)
				);
			}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminGalleryListItem = function (_React$Component) {
	    _inherits(AdminGalleryListItem, _React$Component);

	    function AdminGalleryListItem(props) {
	        _classCallCheck(this, AdminGalleryListItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AdminGalleryListItem).call(this, props));
	    }

	    _createClass(AdminGalleryListItem, [{
	        key: 'render',
	        value: function render() {
	            ...
	            if (gallery.owner) {
	                var galleryOwnerText = _react2.default.createElement(
	                    'p',
	                    { className: 'md-type-body2' },
	                    _react2.default.createElement(
	                        'a',
	                        { href: "/user/" + gallery.owner._id, target: '_blank' },
	            ...
	            var assignmentLink = _react2.default.createElement('div', null);

	            if (gallery.assignment) {
	                assignmentLink = _react2.default.createElement(
	                    'p',
	                    { className: 'md-type-body2 assignment-link', style: { lineHeight: '18px' } },
	                    _react2.default.createElement(
	                        'a',
	                        { href: "/assignment/" + gallery.assignment._id },
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: "list-item" + (this.props.active ? ' active' : ''),
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: "/gallery/" + gallery._id, target: '_blank' },
	                        _react2.default.createElement('img', {
	                            className: 'img-circle',
	                            style: { width: '40px', height: '40px' },
	                            src: _global2.default.formatImg(gallery.posts[0].image, 'small') })
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'flexy list-item-caption' },
	                    _react2.default.createElement(
	                        'p',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'p',
	                        { className: 'md-type-body1 assignment-location', style: gallery.assignment ? { lineHeight: '18px' } : {} },
	                        location
	                    )
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'list-item-timestamp' },
	                    _react2.default.createElement(
	                        'p',
	                        { className: 'md-type-body1' },
	                        _global2.default.formatTime(gallery.time_created)
	                    )
	                )
	            );
	        }
	    ...
	    return AdminGalleryListItem;
	}(_react2.default.Component);

	exports.default = AdminGalleryListItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	**/
	...
	var AdminAssignmentListItem = function (_React$Component) {
	    _inherits(AdminAssignmentListItem, _React$Component);

	    function AdminAssignmentListItem(props) {
	        _classCallCheck(this, AdminAssignmentListItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AdminAssignmentListItem).call(this, props));
	    }

	    _createClass(AdminAssignmentListItem, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: "list-item" + (this.props.active ? ' active' : ''), onClick: this.props.setActiveAssignment.bind(null, assignment._id) },
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'a',
	                            { href: "/assignment/" + assignment._id, target: '_blank' },
	                            assignment.title
	                        )
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'p',
	                        { className: 'md-type-body1 assignment-location', style: assignment.assignment ? { lineHeight: '18px' } : {} },
	                        location
	                    )
	                ),
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'p',
	                        { className: 'md-type-body1' },
	                        _global2.default.formatTime(assignment.time_created)
	                    )
	                )
	            );
	        }
	...
	exports.default = AdminAssignmentListItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _adminGalleryEditFoot = __webpack_require__(316);

	var _adminGalleryEditFoot2 = _interopRequireDefault(_adminGalleryEditFoot);
	...
	**/
	...
	var AdminGalleryEdit = function (_React$Component) {
		_inherits(AdminGalleryEdit, _React$Component);

		function AdminGalleryEdit(props) {
			_classCallCheck(this, AdminGalleryEdit);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AdminGalleryEdit).call(this, props));
			...
			_this.editButtonEnabled = _this.editButtonEnabled.bind(_this);
			_this.handleTwitterBylineChange = _this.handleTwitterBylineChange.bind(_this);
			_this.handleChangeCaption = _this.handleChangeCaption.bind(_this);
	   ...
	   */
			...
			value: function resetState(props) {
				// Reset form
				this.setState({
					activeGallery: _lodash2.default.clone(props.gallery, true),
					tags: [],
					stories: [],
	   ...
	   */
			...
			key: 'handleTwitterBylineChange',
			value: function handleTwitterBylineChange(selected) {
	   ...
	   */
			...
			value: function handleChangeCaption(e) {
				this.setState({
	   ...
	   */
			...
			key: 'updateGallery',
			value: function updateGallery(key, value) {
	   ...
	   */
			...
			key: 'editButtonEnabled',
			value: function editButtonEnabled(is) {
				this.setState({
	   ...
	   */
			...
			value: function revert() {
				this.setState({
					activeGallery: _lodash2.default.clone(this.props.gallery, true)
				});
	   ...
	   */
			...
			value: function remove() {
				...
				this.props.remove(function (err) {
	   ...
	   */
			...
			value: function skip() {
				...
				this.props.skip(function (err, id) {
					...
					$.snackbar({ content: 'Gallery skipped! Click to open', timeout: 5000 }).click(function () {
	   ...
	   */
			...
			value: function verify() {
				...
				var gallery = this.state.activeGallery,
				    ...
				    posts = gallery.posts.map(function (p) {
					return p._id;
				});
				...
				var stories = this.state.activeGallery.related_stories.map(function (story) {
				...
				// Byline
				var byline = _global2.default.getBylineFromComponent(gallery, this.refs.byline);
				...
				this.props.verify(params, function (err, id) {
					_this4.setState({
						waiting: false
					});
			...
			value: function render() {
				...
				if (!this.props.hasActiveGallery || this.props.activeGalleryType == 'assignment' || !this.props.activeGalleryType.length || !this.state.activeGallery || !this.state.activeGallery.posts) {
					return _react2.default.createElement('div', null);
				}
				...
				if (activeGallery.posts) {
					galleryImages = activeGallery.posts.map(function (post, i) {
						if (post.video) {
							return _react2.default.createElement(
								'div',
								{ key: i },
				...
				if (this.props.activeGalleryType == 'submission') {
					...
					if (activeGallery.location) {
						location = activeGallery.location.coordinates[0].map(function (coord) {
							return {
								lat: coord[1],
								lng: coord[0]
							};
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'dialog-body', style: { visibility: this.props.hasActiveGallery ? 'visible' : 'hidden' } },
						_react2.default.createElement(
							'div',
						...
						_react2.default.createElement(_bylineEdit2.default, { ref: 'byline', gallery: activeGallery }),
					...
					_react2.default.createElement(_adminGalleryEditFoot2.default, {
						revert: this.revert,
						verify: this.verify,
						skip: this.skip,
						remove: this.remove,
	...
	exports.default = AdminGalleryEdit;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AdminGalleryEditFoot = function (_React$Component) {
	    _inherits(AdminGalleryEditFoot, _React$Component);

	    function AdminGalleryEditFoot() {
	        _classCallCheck(this, AdminGalleryEditFoot);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AdminGalleryEditFoot).apply(this, arguments));
	    }

	    _createClass(AdminGalleryEditFoot, [{
	        key: "render",
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                ...
	                _react2.default.createElement(
	                    "button",
	                    { type: "button", className: "btn btn-flat gallery-revert", onClick: this.props.revert, disabled: !this.props.enabled },
	                    "Revert changes"
	                ),
	                _react2.default.createElement(
	                    "button",
	                    { type: "button", className: "btn btn-flat pull-right gallery-verify", onClick: this.props.verify, disabled: !this.props.enabled },
	                    "Verify"
	                ),
	                _react2.default.createElement(
	                    "button",
	                    { type: "button", className: "btn btn-flat pull-right gallery-skip", onClick: this.props.skip, disabled: !this.props.enabled },
	                    "Skip"
	                ),
	                _react2.default.createElement(
	                    "button",
	                    { type: "button", className: "btn btn-flat pull-right gallery-delete", onClick: this.props.remove, disabled: !this.props.enabled },
	                    "Delete"
	                )
	            );
	        }
	    ...
	    return AdminGalleryEditFoot;
	}(_react2.default.Component);

	exports.default = AdminGalleryEditFoot;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignmentMerge = __webpack_require__(319);

	var _assignmentMerge2 = _interopRequireDefault(_assignmentMerge);
	...
	**/
	...
	var AdminAssignmentEdit = function (_React$Component) {
	    _inherits(AdminAssignmentEdit, _React$Component);

	    function AdminAssignmentEdit(props) {
	        _classCallCheck(this, AdminAssignmentEdit);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AdminAssignmentEdit).call(this, props));
	        ...
	        _this.onPlaceChange = _this.onPlaceChange.bind(_this);
	        _this.onRadiusUpdate = _this.onRadiusUpdate.bind(_this);
	        _this.onMapDataChange = _this.onMapDataChange.bind(_this);
	        _this.findNearbyAssignments = _this.findNearbyAssignments.bind(_this);
	        _this.toggleMergeDialog = _this.toggleMergeDialog.bind(_this);
	        _this.approve = _this.approve.bind(_this);
	        _this.reject = _this.reject.bind(_this);
	        // this.merge                  = this.merge.bind(this);
	        _this.selectMerge = _this.selectMerge.bind(_this);
	        return _this;
	    }

	    _createClass(AdminAssignmentEdit, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            $.material.init();
	        ...
	        value: function componentWillReceiveProps(nextProps) {
	            if (this.props.assignment._id != nextProps.assignment._id) {
	                if (nextProps.hasActiveGallery) {
	                    ...
	                    this.refs['assignment-expiration'].value = assignment ? _global2.default.hoursToExpiration(assignment.expiration_time) : null;
	        ...
	        key: 'onRadiusUpdate',
	        value: function onRadiusUpdate(radius) {
	            this.setState({
	                radius: _global2.default.feetToMiles(radius)
	            });
	        }
	        ...
	        key: 'findNearbyAssignments',
	        value: function findNearbyAssignments(data) {
	            var _this3 = this;
	        ...
	        value: function approve() {
	            ...
	            $.post('/api/assignment/approve', {
	                ...
	                if (data.err) {
	                    ...
	                    _this4.props.updateAssignment(_this4.props.assignment._id);
	                    $.snackbar({
	        ...
	        value: function reject() {
	            ...
	            $.post('/api/assignment/deny', {
	                ...
	                _this5.props.updateAssignment(_this5.props.assignment._id);
	                if (data.err) {
	                    $.snackbar({
	        ...
	        key: 'toggleMergeDialog',
	        value: function toggleMergeDialog() {
	            var changedState = {
	        ...
	        value: function merge(data) {
	            ...
	            $.post('/api/assignment/merge', data, function (resp) {
	                _this7.toggleMergeDialog();
	                _this7.props.updateAssignment(data.assignmentToDelete);
	        ...
	        value: function render() {
	            ...
	            var radius = Math.round(_global2.default.milesToFeet(this.state.radius)),
	                address = this.state.address ? this.state.address : this.props.assignment.location ? this.props.assignment.location.address : '',
	                expiration_time = this.props.assignment ? _global2.default.hoursToExpiration(this.props.assignment.expiration_time) : null;

	            if (this.props.activeGalleryType != 'assignment' || !this.props.hasActiveGallery) return _react2.default.createElement('div', null);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'dialog-body admin-assignment-edit', style: { visibility: this.props.hasActiveGallery ? 'visible' : 'hidden' } },
	                    _react2.default.createElement('input', {
	                        type: 'text',
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-flat assignment-approve pull-right', onClick: this.approve, disabled: this.isPending },
	                        ' Approve'
	                    ),
	                    _react2.default.createElement(
	                        'button',
	                        { type: 'button', className: 'btn btn-flat assignment-deny pull-right', onClick: this.reject, disabled: this.isPending },
	                        ' Reject'
	                    )
	                ),
	                _react2.default.createElement(_assignmentMerge2.default, {
	    ...
	    return AdminAssignmentEdit;
	}(_react2.default.Component);

	exports.default = AdminAssignmentEdit;

	var AssignmentMergeDropup = function (_React$Component2) {
	    _inherits(AssignmentMergeDropup, _React$Component2);

	    function AssignmentMergeDropup(props) {
	        _classCallCheck(this, AssignmentMergeDropup);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentMergeDropup).call(this, props));
	    }

	    _createClass(AssignmentMergeDropup, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            $(document).click(function (e) {
	        ...
	        value: function render() {
	            ...
	            if (!this.props.nearbyAssignments.length) return _react2.default.createElement('div', null);
	            ...
	            return _react2.default.createElement(
	                ...
	                this.props.nearbyAssignments.map(function (a, i) {
	                    return _react2.default.createElement(AssignmentMergeMenuItem, {
	                        assignment: a,
	                        onClick: _this9.props.selectMerge.bind(null, a._id),
	                        key: i });
	                })
	            );
	        }
	    ...
	    return AssignmentMergeDropup;
	}(_react2.default.Component);

	var AssignmentMergeMenuItem = function (_React$Component3) {
	    _inherits(AssignmentMergeMenuItem, _React$Component3);

	    function AssignmentMergeMenuItem() {
	        _classCallCheck(this, AssignmentMergeMenuItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentMergeMenuItem).apply(this, arguments));
	    }

	    _createClass(AssignmentMergeMenuItem, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                { className: 'assignment-merge-menu-item', onClick: this.props.onClick },
	                _react2.default.createElement(
	                    'span',
	                ...
	                _react2.default.createElement(
	                    'span',
	                    { className: 'assignment-location' },
	                    this.props.assignment.location.googlemaps
	                ),
	                _react2.default.createElement(
	                    'p',
	                    { className: 'assignment-caption' },
	                    this.props.assignment.caption
	                )
	            );
	        }
	    }]);

	    return AssignmentMergeMenuItem;
	}(_react2.default.Component);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentMerge = function (_React$Component) {
	    _inherits(AssignmentMerge, _React$Component);

	    function AssignmentMerge(props) {
	        _classCallCheck(this, AssignmentMerge);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentMerge).call(this, props));
	    ...
	    _createClass(AssignmentMerge, [{
	        ...
	        value: function render() {
	            ...
	            if (!this.props.assignment || !this.props.assignmentToMergeInto) return _react2.default.createElement('div', null);

	            return _react2.default.createElement(
	                'div',
	                { className: 'assignment-merge-container' },
	                _react2.default.createElement('div', { className: "dim toggle-edit " + toggledText, onClick: this.props.toggle }),
	                _react2.default.createElement(
	                    'div',
	                    { className: "edit panel panel-default toggle-edit assignment-merge-dialog" + toggledText },
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-lg-4 visible-lg edit-current assignment-merge-side' },
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                'h1',
	                                null,
	                                this.props.assignmentToMergeInto.title
	                            ),
	                            _react2.default.createElement(
	                                'p',
	                                null,
	                                this.props.assignmentToMergeInto.caption
	                            )
	                        ),
	                        _react2.default.createElement(
	                            'div',
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'col-xs-12 col-lg-8 edit-new dialog' },
	                        _react2.default.createElement(
	                            'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                { className: 'dialog-col col-xs-12 form-group-default' },
	                                _react2.default.createElement(
	                                    'div',
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', className: 'btn btn-flat', onClick: this.cancel },
	                                'Cancel'
	                            ),
	                            _react2.default.createElement(
	                                'button',
	                                { type: 'button', className: 'btn btn-flat pull-right', onClick: this.merge },
	                                'Merge & Update'
	                            )
	                        )
	                    )
	    ...
	    return AssignmentMerge;
	}(_react2.default.Component);

	exports.default = AssignmentMerge;
