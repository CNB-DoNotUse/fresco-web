...
/***/ function(module, exports, __webpack_require__) {
	...
	var _gallerySidebar = __webpack_require__(362);

	var _gallerySidebar2 = _interopRequireDefault(_gallerySidebar);
	...
	var GalleryDetail = function (_React$Component) {
		_inherits(GalleryDetail, _React$Component);

		function GalleryDetail(props) {
			_classCallCheck(this, GalleryDetail);

			// Check if every post in gallery is not verified and show all content

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(GalleryDetail).call(this, props));

			var unverifiedPosts = _this.props.gallery.posts.every(function (post) {
			...
			_this.toggleGalleryEdit = _this.toggleGalleryEdit.bind(_this);
			_this.onVerifiedToggled = _this.onVerifiedToggled.bind(_this);
			_this.updateGallery = _this.updateGallery.bind(_this);
			return _this;
		}

		_createClass(GalleryDetail, [{
			key: 'toggleGalleryEdit',
			value: function toggleGalleryEdit() {
				this.setState({
			...
			value: function onVerifiedToggled(verifiedToggle) {
				this.setState({
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(_topbar2.default, {
						...
						editable: this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER,
						rank: this.props.user.rank,
						edit: this.toggleGalleryEdit,
						verifiedToggle: this.state.shouldShowVerifiedToggle,
						onVerifiedToggled: this.onVerifiedToggled,
						timeToggle: true }),
					_react2.default.createElement(_gallerySidebar2.default, { gallery: this.state.gallery }),
					_react2.default.createElement(
						'div',
	...
	_reactDom2.default.render(_react2.default.createElement(GalleryDetail, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GallerySidebar = function (_React$Component) {
		_inherits(GallerySidebar, _React$Component);

		function GallerySidebar(props) {
			_classCallCheck(this, GallerySidebar);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(GallerySidebar).call(this, props));
		}

		_createClass(GallerySidebar, [{
			key: "render",
			value: function render() {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(GalleryStats, { gallery: this.props.gallery })
							)
						)
					)
				);
	...
	exports.default = GallerySidebar;

	var GalleryStats = function (_React$Component2) {
		_inherits(GalleryStats, _React$Component2);

		function GalleryStats() {
			_classCallCheck(this, GalleryStats);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(GalleryStats).apply(this, arguments));
		}

		_createClass(GalleryStats, [{
			key: "render",
			value: function render() {

				if (!this.props.gallery.stats) return _react2.default.createElement("div", { className: "meta-list" });

				var photos = '',
				    videos = '';

				if (this.props.gallery.stats.photos) {
					photos = _react2.default.createElement(
						"li",
						null,
						...
						_react2.default.createElement(
							...
							" ",
							this.props.gallery.stats.photos > 1 ? 'photos' : 'photo'
						)
					);
				}
				if (this.props.gallery.stats.videos) {
					videos = _react2.default.createElement(
						"li",
						null,
