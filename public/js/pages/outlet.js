...
/***/ function(module, exports, __webpack_require__) {
	...
	var _outletBodyDemo = __webpack_require__(372);

	var _outletBodyDemo2 = _interopRequireDefault(_outletBodyDemo);
	...
	var Outlet = function (_React$Component) {
		...
		function Outlet(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Outlet).call(this, props));
		...
		_createClass(Outlet, [{
			...
			value: function render() {
				...
				if (this.props.outlet.verified) {
					...
					outletBody = _react2.default.createElement(_outletBody2.default, {
						activeTab: this.state.activeTab,
						outlet: this.props.outlet,
						user: this.props.user });
				} else {
					outletBody = _react2.default.createElement(_outletBodyDemo2.default, {
						outlet: this.props.outlet });
				}
	...
	_reactDom2.default.render(_react2.default.createElement(Outlet, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OutletBodyDemo = function (_React$Component) {
	    _inherits(OutletBodyDemo, _React$Component);

	    function OutletBodyDemo() {
	        _classCallCheck(this, OutletBodyDemo);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(OutletBodyDemo).apply(this, arguments));
	    }

	    _createClass(OutletBodyDemo, [{
	        key: 'render',
	        value: function render() {
	            var outlet = this.props.outlet;
	    ...
	    return OutletBodyDemo;
	}(_react2.default.Component);

	exports.default = OutletBodyDemo;
