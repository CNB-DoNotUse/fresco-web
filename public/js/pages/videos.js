...
/***/ function(module, exports, __webpack_require__) {
	...
	var Videos = function (_React$Component) {
		...
		function Videos(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Videos).call(this, props));
		...
		_createClass(Videos, [{
			...
			value: function loadPosts(passedOffset, callback) {
				...
				if (this.state.verifiedToggle) params.verified = this.state.verifiedToggle;
	...
	_reactDom2.default.render(_react2.default.createElement(Videos, {
