...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserSettings = function (_React$Component) {
		...
		function UserSettings(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(UserSettings).call(this, props));

			_this.state = {
				avatar: _this.props.user.avatar || _global2.default.defaultAvatar,
		...
		_createClass(UserSettings, [{
			...
			value: function handleInputChange() {
				...
				var newName = this.refs.name.value != this.props.user.firstname + ' ' + this.props.user.lastname,
				    newBio = !_global2.default.compareMultiline(this.refs.bio.value, this.props.user.bio),
	   ...
	   */
			...
			value: function updateSettings() {
				...
				} else if (_global2.default.isEmptyString(lastname)) {
					return $.snackbar({ content: 'You must have a lastname!' });
				} else if (_global2.default.isEmptyString(email)) {
				...
				$.ajax({
					...
					success: function success(response, status, xhr) {
						...
						if (response.err) {
							...
							//Update the user
							user.firstname = firstname, user.lastname = lastname, user.avatar = self.state.avatar;
					...
					error: function error(xhr, status, _error) {
						self.updating = false;
						$.snackbar({
							content: _global2.default.resolveError(_error, 'We couldn\'t save your settings!')
						});
					}
				});
			}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							{ className: 'card settings-user-account' },
							_react2.default.createElement(
								'div',
								{ className: 'header' },
								_react2.default.createElement(
	...
	var ChangePasswordCard = function (_React$Component2) {
		_inherits(ChangePasswordCard, _React$Component2);

		function ChangePasswordCard() {
			_classCallCheck(this, ChangePasswordCard);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(ChangePasswordCard).apply(this, arguments));
		}

		_createClass(ChangePasswordCard, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
	...
	_reactDom2.default.render(_react2.default.createElement(UserSettings, {
