...
/***/ function(module, exports, __webpack_require__) {
	...
	var _userSidebar = __webpack_require__(404);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_topbar2.default, {
	          ...
	          editable: this.props.editable,
	          edit: this.edit }),
	        _react2.default.createElement(_userSidebar2.default, {
	          user: this.props.user,
	...
	_reactDom2.default.render(_react2.default.createElement(UserDetail, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UserSidebar = function (_React$Component) {
		_inherits(UserSidebar, _React$Component);
		...
		_createClass(UserSidebar, [{
			...
			value: function render() {
				...
				var user = this.props.detailUser,
				    ...
				    avatar = user.avatar || _global2.default.defaultAvatar,
				...
				if (this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER) {
					...
					if (user.email !== null) email = _react2.default.createElement(
						'li',
						{ className: 'ellipses' },
						_react2.default.createElement('span', { className: 'mdi mdi-email icon' }),
						_react2.default.createElement(
							'a',
							{ target: '_top', href: 'mailto:' + user.email },
							user.email
						)
					);

					if (user.stripe !== null) stripe = _react2.default.createElement(
						'li',
						{ className: 'ellipses' },
						_react2.default.createElement('span', { className: 'mdi mdi-bank icon' }),
						_react2.default.createElement(
							'a',
							{ target: '_top', href: 'https://dashboard.stripe.com/' + user.stripe },
							'Stripe'
						)
					);
				}
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											'li',
											null,
											_react2.default.createElement('span', { className: 'mdi mdi-image-multiple icon' }),
											galleries + ' galleries'
										),
										_react2.default.createElement(
											'li',
