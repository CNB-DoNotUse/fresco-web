...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storySidebar = __webpack_require__(400);

	var _storySidebar2 = _interopRequireDefault(_storySidebar);

	var _storyEdit = __webpack_require__(401);
	...
	var StoryDetail = function (_React$Component) {
		_inherits(StoryDetail, _React$Component);

		function StoryDetail(props) {
			_classCallCheck(this, StoryDetail);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StoryDetail).call(this, props));

			_this.state = {
				storyEditToggled: false,
				story: _this.props.story,
				sort: _this.props.sort || 'upload'
			};
			_this.toggleStoryEdit = _this.toggleStoryEdit.bind(_this);
			_this.loadPosts = _this.loadPosts.bind(_this);
			_this.updateStory = _this.updateStory.bind(_this);
		...
		_createClass(StoryDetail, [{
			...
			key: 'toggleStoryEdit',
			value: function toggleStoryEdit() {
				this.setState({
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_topbar2.default, {
						...
						timeToggle: true,
						chronToggle: true }),
					_react2.default.createElement(_storySidebar2.default, { story: this.state.story }),
					_react2.default.createElement(
						'div',
					...
					_react2.default.createElement(_storyEdit2.default, {
			...
			key: 'loadPosts',
			value: function loadPosts(passedOffset, callback) {
	...
	_reactDom2.default.render(_react2.default.createElement(StoryDetail, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StorySidebar = function (_React$Component) {
		_inherits(StorySidebar, _React$Component);

		function StorySidebar() {
			_classCallCheck(this, StorySidebar);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(StorySidebar).apply(this, arguments));
		}

		_createClass(StorySidebar, [{
			key: "render",
			value: function render() {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(StoryStats, { story: this.props.story })
							)
						)
					)
				);
	...
	exports.default = StorySidebar;

	var StoryStats = function (_React$Component2) {
		_inherits(StoryStats, _React$Component2);

		function StoryStats() {
			_classCallCheck(this, StoryStats);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(StoryStats).apply(this, arguments));
		}

		_createClass(StoryStats, [{
			key: "render",
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							"li",
							null,
							_react2.default.createElement("span", { className: "mdi mdi-image-multiple icon story-galleries" }),
							_react2.default.createElement(
								"span",
								null,
								this.props.story.stats.galleries,
								" ",
								this.props.story.stats.galleries > 1 ? 'galleries' : 'gallery'
							)
						),
						_react2.default.createElement(
							"li",
							...
							_react2.default.createElement(
								...
								" ",
								this.props.story.stats.photos > 1 ? 'photos' : 'photo'
							)
						),
						_react2.default.createElement(
							"li",
							...
							_react2.default.createElement(
								"span",
								null,
								this.props.story.stats.videos,
								" ",
								this.props.story.stats.videos > 1 ? 'videos' : 'video'
							)
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storyEditStats = __webpack_require__(402);

	var _storyEditStats2 = _interopRequireDefault(_storyEditStats);
	...
	var StoryEdit = function (_React$Component) {
		_inherits(StoryEdit, _React$Component);

		function StoryEdit(props) {
			_classCallCheck(this, StoryEdit);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(StoryEdit).call(this, props));
		...
		_createClass(StoryEdit, [{
			...
			value: function _delete() {
				...
				alertify.confirm("Are you sure you want to delete this story? This cannot be undone.", function (e) {
					$.post('/api/story/delete', {
						id: _this2.props.story._id
					}, function (data) {
						if (data.err) {
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: "edit panel panel-default toggle-edit " + toggled },
						_react2.default.createElement(
							'div',
							{ className: 'col-lg-4 visible-lg edit-current' },
							_react2.default.createElement(_storyEditStats2.default, { story: this.props.story })
						),
						_react2.default.createElement(
							'div',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'button',
									{ id: 'story-edit-revert', type: 'button', className: 'btn btn-flat', onClick: this.revert },
									'Revert changes'
								),
								_react2.default.createElement(
									'button',
									{ id: 'story-edit-clear', type: 'button', className: 'btn btn-flat', onClick: this.clear },
									'Clear all'
								),
								_react2.default.createElement(
									'button',
									{ id: 'story-edit-save', type: 'button', className: 'btn btn-flat pull-right', onClick: this.save },
									'Save'
								),
								_react2.default.createElement(
									'button',
									{ id: 'story-edit-delete', type: 'button', className: 'btn btn-flat pull-right', onClick: this.delete },
									'Delete'
								),
								_react2.default.createElement(
									'button',
									{ id: 'story-edit-discard', type: 'button', className: 'btn btn-flat pull-right toggle-edit toggler', onClick: this.cancel },
									'Discard'
								)
							),
							_react2.default.createElement(
	...
	exports.default = StoryEdit;


	StoryEdit.defaultProps = {
		toggled: false,
		toggle: function toggle() {
			console.log('StoryEdit missing toggle implementation');
		}
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var StoryEditStats = function (_React$Component) {
		_inherits(StoryEditStats, _React$Component);

		function StoryEditStats(props) {
			_classCallCheck(this, StoryEditStats);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(StoryEditStats).call(this, props));
		}

		_createClass(StoryEditStats, [{
			key: 'render',
			value: function render() {
				return _react2.default.createElement(
					'div',
					{ className: 'meta' },
					_react2.default.createElement('div', { id: 'story-edit-caption', className: 'meta-description' }),
					_react2.default.createElement(
						'div',
						{ className: 'meta-list' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'span',
									{ id: 'story-edit-date' },
									_global2.default.formatTime(this.props.story.time_created)
								)
							),
							_react2.default.createElement(
								'li',
								...
								_react2.default.createElement(
									'span',
									{ id: 'story-edit-photo-num' },
									this.props.story.stats.photos,
									' ',
									this.props.story.stats.photos == 1 ? 'photo' : 'photos'
								)
							),
							_react2.default.createElement(
								'li',
								...
								_react2.default.createElement(
									'span',
									{ id: 'story-edit-video-num' },
									this.props.story.stats.videos,
									' ',
									this.props.story.stats.videos == 1 ? 'video' : 'videos'
								)
							)
						)
					)
		...
		return StoryEditStats;
	}(_react2.default.Component);

	exports.default = StoryEditStats;
