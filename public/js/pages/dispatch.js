...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatchMap = __webpack_require__(345);

	var _dispatchMap2 = _interopRequireDefault(_dispatchMap);

	var _dispatchAssignments = __webpack_require__(351);

	var _dispatchAssignments2 = _interopRequireDefault(_dispatchAssignments);

	var _dispatchSubmit = __webpack_require__(353);

	var _dispatchSubmit2 = _interopRequireDefault(_dispatchSubmit);

	var _dispatchRequest = __webpack_require__(354);
	...
	var Dispatch = function (_React$Component) {
		...
		function Dispatch(props) {
			...
			_this.mapShouldUpdate = _this.mapShouldUpdate.bind(_this);
			_this.findAssignments = _this.findAssignments.bind(_this);
			_this.updateMapPlace = _this.updateMapPlace.bind(_this);
			_this.updateCurrentBounds = _this.updateCurrentBounds.bind(_this);
			_this.updateViewMode = _this.updateViewMode.bind(_this);
			_this.setActiveAssignment = _this.setActiveAssignment.bind(_this);
			_this.updateNewAssignment = _this.updateNewAssignment.bind(_this);
			_this.toggleSubmissionCard = _this.toggleSubmissionCard.bind(_this);
			return _this;
		}
	  ...
	  */
		...
		_createClass(Dispatch, [{
			key: 'mapShouldUpdate',
			value: function mapShouldUpdate(should) {
				this.setState({
	   ...
	   */
			...
			key: 'updateNewAssignment',
			value: function updateNewAssignment(location, radius, zoom, source) {
	   ...
	   */
			...
			key: 'updateMapPlace',
			value: function updateMapPlace(place) {
	   ...
	   */
			...
			key: 'updateViewMode',
			value: function updateViewMode(viewMode) {
	   ...
	   */
			...
			key: 'findAssignments',
			value: function findAssignments(map, params, callback) {
				...
				if (map) {
					...
					var proximitymeter = google.maps.geometry.spherical.computeDistanceBetween(bounds.getSouthWest(), bounds.getNorthEast()),
	   ...
	   */
			...
			key: 'findUsers',
			value: function findUsers(map, callback) {
				...
				$.ajax('/api/user/findInRadius?' + query, {
					success: function success(response) {
						...
						//Do nothing, because of bad response
						if (!response.data || response.err) callback(null, 'Error');else callback(response.data, null);
					},
					error: function error(xhr, status, _error2) {
						return callback(null, _error2);
					}
				});
			}
	   ...
	   */
			...
			key: 'toggleSubmissionCard',
			value: function toggleSubmissionCard(show, event) {
	   ...
	   */
			...
			value: function render() {
				...
				if (this.props.user.outlet && this.props.user.outlet.dispatch_enabled) {
					...
					cards.push(_react2.default.createElement(_dispatchAssignments2.default, {
						key: key++,
					...
					cards.push(_react2.default.createElement(_dispatchSubmit2.default, {
						user: this.props.user,
					...
					cards.push(_react2.default.createElement(_dispatchRequest2.default, { key: key++ }));
				}

				var statsDownloadButton = '';

				if (this.props.user.rank > 1) {
					statsDownloadButton = _react2.default.createElement(
						'button',
						{
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_dispatchMap2.default, {
						user: this.props.user,
	...
	_reactDom2.default.render(_react2.default.createElement(Dispatch, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dispatchMapCallout = __webpack_require__(350);
	...
	**/
	...
	var DispatchMap = function (_React$Component) {
		_inherits(DispatchMap, _React$Component);

		function DispatchMap(props) {
			_classCallCheck(this, DispatchMap);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DispatchMap).call(this, props));
			...
			_this.clearAssignments = _this.clearAssignments.bind(_this);
			_this.clearCallout = _this.clearCallout.bind(_this);
			_this.updateAssignmentMarkers = _this.updateAssignmentMarkers.bind(_this);
			_this.updateUserMarkers = _this.updateUserMarkers.bind(_this);
			_this.focusOnAssignment = _this.focusOnAssignment.bind(_this);
			_this.addAssignmentsToMap = _this.addAssignmentsToMap.bind(_this);
			_this.addAssignmentToMap = _this.addAssignmentToMap.bind(_this);
			_this.addAssignmentMarker = _this.addAssignmentMarker.bind(_this);
			_this.saveMapLocation = _this.saveMapLocation.bind(_this);
			return _this;
		}

		_createClass(DispatchMap, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				var _this2 = this;
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				if (!this.isOpeningCallout && nextProps.activeAssignment && (!this.props.activeAssignment || nextProps.activeAssignment._id != this.props.activeAssignment._id)) {
			...
			value: function componentDidUpdate(prevProps, prevState) {
				...
				if (this.state.newAssignmentMarker && this.state.newAssignmentCircle) {
					...
					if (this.props.newAssignment) {
						...
						if (prevProps.newAssignment.radius != this.props.newAssignment.radius) {
							circle.setRadius(_global2.default.milesToMeters(this.props.newAssignment.radius));
						}
					}
				...
				//Otherwise make the marker
						...
						google.maps.event.addListener(marker, 'dragend', function (ev) {
							...
							_this3.props.updateNewAssignment({
								lat: ev.latLng.lat(),
								lng: ev.latLng.lng()
							}, _this3.props.newAssignment.radius, _this3.state.map.getZoom(), 'markerDrag');
						});
					}
			}
	   ...
	   */
			...
			key: 'saveMapLocation',
			value: function saveMapLocation() {
	   ...
	   */
			...
			value: function clearAssignments() {
	   ...
	   */
			...
			value: function updateMap() {
				...
				//Get assignments
				this.props.findAssignments(this.state.map, null, function (assignments) {
					//Get users
					_this4.props.findUsers(_this4.state.map, function (users, error) {

						var changedState = {},
						    currentAssignments = _lodash2.default.clone(_this4.state.assignments);

						//Map out passed assignment IDs
						var newAssignmentIds = assignments.map(function (assignment) {
							return assignment._id;
						});

						//Map out current assignment IDs
						var currentAssignmentIds = currentAssignments.map(function (assignment) {
							return assignment._id;
						});

						//Check if there's a difference
						if (_lodash2.default.difference(newAssignmentIds, currentAssignmentIds).length) {
						...
						if (currentAssignments.length > _this4.state.assignments.length) changedState.assignments = currentAssignments;
						...
						_this4.updateUserMarkers(formattedUsers, function (markers) {
							changedState.userMarkers = markers;
							changedState.users = formattedUsers;

							_this4.setState(changedState);
						});
					});
				});
			}
	   ...
	   */
			...
			key: 'updateAssignmentMarkers',
			value: function updateAssignmentMarkers(prevAssignments) {
				var assignments = [];

				//Map out all of the previous assignmnets
				var prevAssignmentIds = prevAssignments.map(function (assignment) {
	   ...
	   */
			...
			key: 'updateUserMarkers',
			value: function updateUserMarkers(newUsers, callback) {
				var keys = Object.keys(newUsers),
				    markers = _lodash2.default.clone(this.state.userMarkers);

				//Make keys after the loop, because keys may have been deleted
				var currentUsers = _lodash2.default.clone(this.state.users),
				...
				if (currentUsers.length !== this.state.users.length) currentUserKeys = Object.keys(currentUsers);
	   ...
	   */
			...
			key: 'addAssignmentsToMap',
			value: function addAssignmentsToMap(assignments) {
				var markers = [],
				    circles = [];
	   ...
	   */
			...
			key: 'addAssignmentToMap',
			value: function addAssignmentToMap(assignment, draggable) {
				...
				var map = this.state.map,
				    ...
				    zIndex,
				    status,
				    position = new google.maps.LatLng(assignment.location.geo.coordinates[1], assignment.location.geo.coordinates[0]),
				...
				var circle = this.addCircle(position, _global2.default.milesToMeters(radius), status, assignment._id);

				//Create the marker
				var marker = this.addAssignmentMarker(position, title, status, zIndex, draggable, assignment._id);

				//Add event handler to display callout when clicekd
				google.maps.event.addListener(marker, 'click', this.focusOnAssignment.bind(null, assignment));
			...
			key: 'addAssignmentMarker',
			value: function addAssignmentMarker(position, title, status, zIndex, draggable, assignmentId) {

				//Create the marker image
				var image = {
					url: status ? _global2.default.assignmentImage[status] : _global2.default.assignmentImage.drafted,
					size: new google.maps.Size(108, 114),
					scaledSize: new google.maps.Size(36, 38),
					origin: new google.maps.Point(0, 0),
					anchor: new google.maps.Point(18, 19)
	   ...
	   */
			...
			key: 'addCircle',
			value: function addCircle(center, radius, status, assignmentId) {

				var fillColor = _global2.default.assignmentColor[status],
	   ...
	   */
			...
			value: function focusOnAssignment(assignment) {
				var _this5 = this;
				...
				var calloutContent = _server2.default.renderToString(_react2.default.createElement(_dispatchMapCallout2.default, { assignment: assignment }));
				...
				google.maps.event.addListener(callout, 'closeclick', function () {
					_this5.clearCallout();
				});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'map-container full dispatch' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DispatchMapCallout = function (_React$Component) {
		_inherits(DispatchMapCallout, _React$Component);

		function DispatchMapCallout(props) {
			_classCallCheck(this, DispatchMapCallout);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(DispatchMapCallout).call(this, props));
		}

		_createClass(DispatchMapCallout, [{
			key: "render",
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						"div",
						{ className: "assignment-callout-main" },
						_react2.default.createElement(
							"div",
							{ className: "md-type-body2 assignment-callout-title" },
							assignment.title
						),
						_react2.default.createElement(
							"div",
							{ className: "md-type-body1 assignment-callout-caption" },
							assignment.caption
						),
						_react2.default.createElement(
							"div",
							{ className: "assignment-callout-buttons" },
							_react2.default.createElement("span", { className: "mdi mdi-image icon assignment-callout-icon" }),
							_react2.default.createElement(
								"span",
								{ className: "assignment-callout-image-counter" },
								assignment.posts.length
							),
							_react2.default.createElement(
								"button",
								{
		...
		return DispatchMapCallout;
	}(_react2.default.Component);

	exports.default = DispatchMapCallout;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignmentListItem = __webpack_require__(352);

	var _assignmentListItem2 = _interopRequireDefault(_assignmentListItem);
	...
	var DispatchAssignments = function (_React$Component) {
		_inherits(DispatchAssignments, _React$Component);

		function DispatchAssignments(props) {
			_classCallCheck(this, DispatchAssignments);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DispatchAssignments).call(this, props));
		...
		_createClass(DispatchAssignments, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				var _this2 = this;

				//Access parent var load method
				this.loadAssignments(0, 'active', function (assignments) {
			...
			value: function componentDidUpdate(prevProps, prevState) {
				...
				if (prevProps.viewMode !== this.props.viewMode) {
					...
					//Access parent var load method
					this.loadAssignments(0, this.props.viewMode, function (assignments) {
			...
			key: 'scroll',
			value: function scroll(type, event) {
				var _this4 = this;

				var grid;

				if (type == 'active') grid = this.refs.activeList;else if (type == 'pending') grid = this.refs.pendingList;else if (type == 'expired') grid = this.refs.expiredList;
				...
				if (!this.state.loading && grid.scrollTop === grid.scrollHeight - grid.offsetHeight) {
					...
					//Access parent var load method
					this.loadAssignments(this.state.offset, this.props.viewMode, function (assignments) {
						var offset = _this4.state.assignments.length + assignments.length;

						//Set galleries from successful response, and unset loading
						_this4.setState({
							assignments: _this4.state.assignments.concat(assignments),
							offset: offset,
							loading: false
						});
					});
	   ...
	   */
			...
			key: 'loadAssignments',
			value: function loadAssignments(passedOffset, type, callback) {
				...
				this.props.findAssignments(null, params, function (response) {
					//Do nothing, because of bad response
					if (!response || response.err) callback([]);else {
						callback(response);
					}
				});
			}
			...
			value: function render() {
				...
				var AssignmentList = this.state.assignments.map(function (assignment, i) {
					return _react2.default.createElement(_assignmentListItem2.default, {
						assignment: assignment,
						setActiveAssignment: _this5.props.setActiveAssignment,
						key: i });
				});
				...
				return _react2.default.createElement(
					'div',
					{ className: 'card panel assignments-panel' },
					_react2.default.createElement(
						'div',
						{ className: 'card-head small' },
						_react2.default.createElement(
							'div',
							{ className: 'tab-control full' },
							_react2.default.createElement(
								'button',
								{ ref: 'active-button',
					...
					_react2.default.createElement(
						'div',
						{ className: 'card-foot center toggle-card' },
						_react2.default.createElement(
							'button',
							{
								type: 'button',
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'div',
									{
										ref: 'activeList',
										className: 'list',
										onScroll: this.scroll.bind(null, 'active') },
									AssignmentList
								)
							),
							_react2.default.createElement(
								...
								_react2.default.createElement('div', {
									ref: 'pendingList',
									className: 'list',
									onScroll: this.scroll.bind(null, 'pending') })
							),
							_react2.default.createElement(
								'div',
								{ className: 'tab' },
								_react2.default.createElement('div', {
									ref: 'historyList',
									className: 'list',
									onScroll: this.scroll.bind(null, 'expired') })
							)
						)
					)
				);
	...
	exports.default = DispatchAssignments;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentListItem = function (_React$Component) {
	    _inherits(AssignmentListItem, _React$Component);

	    function AssignmentListItem(props) {
	        _classCallCheck(this, AssignmentListItem);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentListItem).call(this, props));
	    }

	    _createClass(AssignmentListItem, [{
	        key: 'render',
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    null,
	                    _react2.default.createElement('img', { className: 'img-circle', src: imageUrl })
	                ),
	                _react2.default.createElement(
	                    'div',
	                    { className: 'flexy' },
	                    ...
	                    _react2.default.createElement(
	                        'span',
	                        { className: 'md-type-caption md-type-black-secondary' },
	...
	exports.default = AssignmentListItem;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DispatchSubmit = function (_React$Component) {
		_inherits(DispatchSubmit, _React$Component);

		function DispatchSubmit(props) {
			_classCallCheck(this, DispatchSubmit);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DispatchSubmit).call(this, props));
			...
			_this.autocompleteUpdated = _this.autocompleteUpdated.bind(_this);
			_this.editMapChanged = _this.editMapChanged.bind(_this);
			return _this;
		}

		_createClass(DispatchSubmit, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				$.material.init();
			}
			...
			value: function componentWillReceiveProps(nextProps) {
				...
				function geocode(geo) {
					if (JSON.stringify(geo) !== JSON.stringify(self.currentGeocode)) return;
			...
			key: 'editMapChanged',
			value: function editMapChanged(data) {
				//Update the position to the parent component
	   ...
	   */
			...
			value: function autocompleteUpdated(autocompleteData) {
				//Update the position to the parent component
				this.props.updateNewAssignment(autocompleteData.location, this.props.newAssignment ? this.props.newAssignment.radius : null, this.props.newAssignment ? this.props.newAssignment.zoom : null, 'autocomplete');
	   ...
	   */
			...
			value: function updateRadius(e) {
				var radiusInMiles = _global2.default.feetToMiles(parseFloat(this.refs['radius'].value));

				if (radiusInMiles == 'NaN') return;

				this.props.updateNewAssignment(this.props.newAssignment.location, radiusInMiles, this.props.newAssignment.zoom);
			}
	   ...
	   */
			...
			value: function submitForm() {
				...
				var assignment = {
					...
					radius: _global2.default.feetToMiles(parseInt(this.refs.radius.value)),
				...
				/* Run Checks */
				if (_global2.default.isEmptyString(assignment.title)) {
					$.snackbar({ content: 'Your assignment must have a title!' });
					return;
				}
				if (_global2.default.isEmptyString(assignment.caption)) {
					$.snackbar({ content: 'Your assignment must have a caption!' });
					return;
				}
				if (_global2.default.isEmptyString(assignment.googlemaps)) {
				...
				if (!_global2.default.isValidRadius(assignment.radius)) {
				...
				$.ajax({
					...
					success: function success(result) {
						...
						if (result.err) {
							...
							_this2.props.toggleSubmissionCard(false, null);

							_this2.props.updateViewMode('pending');

							//Tell the main map to update itself, to reflect the new assignment
							_this2.props.mapShouldUpdate(true);
							...
							_this2.refs.caption.value = '';
							_this2.refs.expiration.value = '';
			...
			value: function render() {
				...
				if (this.props.user.outlet && this.props.user.outlet.card) {
					paymentStatus = _react2.default.createElement('span', { className: 'mdi mdi-check available' });
					paymentMessage = 'Payment information available';
				} else {
					paymentStatus = _react2.default.createElement('span', { className: 'mdi mdi-close unavailable' });
					paymentMessage = 'Payment information unavailable';
				}

				return _react2.default.createElement(
					'div',
					{ className: 'card panel toggle-card toggled', id: 'dispatch-submit' },
					_react2.default.createElement(
						'div',
						{ className: 'card-head' },
						_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'button',
							{
								...
								disabled: !this.props.user.outlet && !this.props.user.outlet.card },
							'Submit'
						)
					),
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_editMap2.default, {
								location: location,
								radius: _global2.default.milesToFeet(radius),
								zoom: zoom,
								type: 'drafted',
						...
						_react2.default.createElement(
							'a',
							{ className: 'payment', href: '/outlet/settings' },
							paymentStatus,
							paymentMessage
						)
					)
	...
	exports.default = DispatchSubmit;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var DispatchRequest = function (_React$Component) {
		_inherits(DispatchRequest, _React$Component);

		function DispatchRequest(props) {
			_classCallCheck(this, DispatchRequest);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DispatchRequest).call(this, props));

			_this.submitRequest = _this.submitRequest.bind(_this);
			return _this;
		}

		_createClass(DispatchRequest, [{
			key: 'submitRequest',
				...
				$.ajax({
					...
					success: function success(result) {
						...
						if (!result.err) {
							...
							_this2.refs['request-card'].className += ' toggled';
						} else {
							$.snackbar({
								content: global.resolveError(result.err, 'We ran into an error submitting your request! Please contact us directly at info@fresconews.com')
							});
						}
					}
				});
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ className: 'card panel toggle-card', ref: 'request-card' },
					_react2.default.createElement(
						'div',
						{ className: 'card-head' },
						_react2.default.createElement(
							'span',
							{ className: 'md-type-title' },
							'Request access to Dispatch'
						),
						_react2.default.createElement('span', { id: 'close-request-access-window', className: 'mdi mdi-close pull-right icon toggle-card toggler' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'card-foot center' },
