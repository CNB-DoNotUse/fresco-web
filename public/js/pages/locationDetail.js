...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationDropdown = function (_React$Component) {
		...
		function LocationDropdown(props) {
			...
			_this.locationClicked = _this.locationClicked.bind(_this);
			return _this;
		}
		...
		_createClass(LocationDropdown, [{
			...
			key: 'locationClicked',
			value: function locationClicked(location) {
			...
			value: function addLocation(e) {
				...
				if (this.props.mapPlace) {
					...
					if (!place || !place.geometry || !place.geometry.viewport) {
						return $.snackbar({
							content: _global2.default.resolveError('ERR_UNSUPPORTED_LOCATION')
						});
					}
	   ...
	   */
			...
			value: function loadLocations() {
				...
				$.ajax({
					...
					error: function error(xhr, status, _error2) {
						$.snackbar({
							content: _global2.default.resolveError(_error2, 'We\'re unable to load your locations at the moment! Please try again in a bit.')
						});
					}
				});
			}
			...
			value: function render() {
				...
				var locations = this.state.locations.map(function (location, i) {
					...
					return _react2.default.createElement(
						'li',
						{ className: 'location-item', key: i, onClick: _this2.locationClicked.bind(null, location) },
						_react2.default.createElement(
							'a',
							{ href: "/location/" + location._id },
							_react2.default.createElement('span', { className: 'mdi mdi-logout-variant icon' })
						),
						_react2.default.createElement(
							'span',
							{ className: 'area' },
				...
				dropdownActions.push(_react2.default.createElement(
					'a',
					{ href: '/outlet/settings', key: 2 },
					_react2.default.createElement('span', { className: 'mdi mdi-settings' })
				));

				if (this.props.addLocationButton) {
					dropdownActions.push(_react2.default.createElement('span', { className: 'mdi mdi-playlist-plus', onClick: this.addLocation, key: 1 }));
				}

				if (locations.length == 0) {
					dropdownBody = _react2.default.createElement('div', { className: 'dropdown-body' });
				} else {
					dropdownBody = _react2.default.createElement(
						'ul',
						{ className: 'list' },
						locations
					);
	...
	_dropdown2.default.defaultProps = {
		inList: false,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _locationDropdown = __webpack_require__(355);
	...
	var LocationDetail = function (_React$Component) {
		...
		function LocationDetail(props) {
			...
			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(LocationDetail).call(this, props));
		...
		_createClass(LocationDetail, [{
			...
			value: function componentWillMount() {
				...
				if (_typeof(window.sessionStorage.sinceList) !== 'object') {
	   ...
	   */
			...
			key: 'loadPosts',
			value: function loadPosts(passedId, callback) {
				var params = {
					id: this.props.location._id,
					limit: _global2.default.postCount,
	...
	_reactDom2.default.render(_react2.default.createElement(LocationDetail, {
