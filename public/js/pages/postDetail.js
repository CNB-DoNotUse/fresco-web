...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postInfo = __webpack_require__(382);

	var _postInfo2 = _interopRequireDefault(_postInfo);

	var _postRelated = __webpack_require__(383);

	var _postRelated2 = _interopRequireDefault(_postRelated);

	var _postRelatedTags = __webpack_require__(385);

	var _postRelatedTags2 = _interopRequireDefault(_postRelatedTags);

	var _postDetailImage = __webpack_require__(386);

	var _postDetailImage2 = _interopRequireDefault(_postDetailImage);
	...
	var PostDetail = function (_React$Component) {
	  ...
	  function PostDetail(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PostDetail).call(this, props));
	  ...
	  _createClass(PostDetail, [{
	    ...
	    value: function render() {
	      ...
	      var editable = this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER && this.state.gallery._id,
	          galleryEdit = '',
	          relatedPosts = '',
	          relatedTags = '';

	      if (editable) {
	        galleryEdit = _react2.default.createElement(_galleryEdit2.default, {
	          gallery: this.state.gallery,
	          toggled: this.state.toggled,
	          toggle: this.toggle,
	          updateGallery: this.updateGallery,
	      ...
	      relatedPosts = _react2.default.createElement(_postRelated2.default, { gallery: this.state.gallery });

	      relatedTags = _react2.default.createElement(_postRelatedTags2.default, { tags: this.state.gallery.tags });
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'main' },
	              _react2.default.createElement(_postDetailImage2.default, {
	                post: this.state.post,
	                user: this.props.user,
	                purchases: this.props.purchases }),
	              _react2.default.createElement(_postInfo2.default, (_React$createElement = {
	                user: this.props.user,
	                post: this.state.post,
	                gallery: this.state.gallery
	              }, _defineProperty(_React$createElement, 'user', this.props.user), _defineProperty(_React$createElement, 'verifier', this.props.verifier), _React$createElement))
	            )
	          ),
	          relatedPosts,
	          relatedTags
	...
	_reactDom2.default.render(_react2.default.createElement(PostDetail, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostInfo = function (_React$Component) {
		...
		function PostInfo() {
			...
			return _possibleConstructorReturn(this, Object.getPrototypeOf(PostInfo).apply(this, arguments));
		}
		...
		_createClass(PostInfo, [{
			...
			value: function render() {
				...
				var post = this.props.post,
				    ...
				    twitter = '',
				    curator = '',
				    timeString = _global2.default.formatTime(this.props.post.time_created, true),
				    verifiedBy = '',
				    verifyClass = '',
				    userName = '';

				//Define username based on post meta
				if (post.meta.twitter) userName = post.meta.twitter.user_name;else if (post.owner) userName = post.owner.firstname + ' ' + post.owner.lastname;
				...
				if (this.props.post.approvals) {
					...
					if (this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER && this.props.verifier) {
				...
				if (this.props.post.owner) {
					userIcon = _react2.default.createElement(
						'div',
						null,
						_react2.default.createElement('img', {
				...
				if (post.meta.twitter && post.meta.twitter.url) {
					var twitter = _react2.default.createElement(
						'li',
						null,
						_react2.default.createElement('span', { className: 'mdi mdi-twitter icon' }),
						_react2.default.createElement(
							'a',
				...
				if (gallery.curator && this.props.user.rank > 1) {
					var curator = _react2.default.createElement(
						'li',
						null,
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									...
									_react2.default.createElement(
										'a',
										{ href: post.owner ? "/user/" + post.owner._id : "" },
										_react2.default.createElement(
											'span',
											{ className: 'md-type-title' },
											userName
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement('span', { className: verifyClass }),
									verifiedBy
								),
								curator
							)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postRelatedImage = __webpack_require__(384);

	var _postRelatedImage2 = _interopRequireDefault(_postRelatedImage);
	...
	var PostRelated = function (_React$Component) {
		_inherits(PostRelated, _React$Component);

		function PostRelated(props) {
			_classCallCheck(this, PostRelated);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PostRelated).call(this, props));
			...
			if (_this.props.gallery.posts.length > 1) {
				_this.state.stories.gallery = _this.props.gallery.posts;
				_this.state.selectedTab = 'gallery';
			} else if (_this.props.gallery.related_stories.length > 0) {
				_this.state.selectedTab = _this.props.gallery.related_stories[0]._id;
			}

			_this.getStories = _this.getStories.bind(_this);
			_this.setDisplayedTab = _this.setDisplayedTab.bind(_this);
			return _this;
		}
		...
		_createClass(PostRelated, [{
			...
			key: 'setDisplayedTab',
			value: function setDisplayedTab(event) {
			...
			value: function render() {
				...
				if (this.state.stories.gallery) {
					var posts = this.state.stories.gallery.map(function (post, i) {
						return _react2.default.createElement(_postRelatedImage2.default, { post: post, key: i });
					});

					var toggled = this.state.selectedTab === 'gallery' ? 'toggled' : '';

					tabs.push(_react2.default.createElement(
						'div',
						{ className: "tab " + toggled, key: 'gallery' },
						_react2.default.createElement(
							'div',
							{ className: 'tab-inner' },
							_react2.default.createElement(
								'a',
								{ className: 'btn btn-flat', href: "/gallery/" + this.props.gallery._id },
								'See all'
							),
							posts
						)
					...
					tabControls.push(_react2.default.createElement(
						'button',
						{
				...
				try {
					for (var _iterator = this.props.gallery.related_stories[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						...
						var _posts = this.state.stories[story._id].map(function (post, i) {
							return _react2.default.createElement(_postRelatedImage2.default, { post: post, key: i });
						});

						var _toggled = this.state.selectedTab === story._id ? 'toggled' : '';

						tabs.push(_react2.default.createElement(
							'div',
							{ className: "tab " + _toggled, key: story._id },
							_react2.default.createElement(
								'div',
								{ className: 'tab-inner' },
								_react2.default.createElement(
									'a',
									{ className: 'btn btn-flat', href: "/story/" + story._id },
									'See all'
								),
								_posts
							)
						...
						tabControls.push(_react2.default.createElement(
							'button',
							{
								className: "btn btn-flat " + _toggled,
								key: story._id,
								onClick: this.setDisplayedTab,
								'data-tab': story._id },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostRelatedImage = function (_React$Component) {
	    _inherits(PostRelatedImage, _React$Component);

	    function PostRelatedImage() {
	        _classCallCheck(this, PostRelatedImage);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(PostRelatedImage).apply(this, arguments));
	    }

	    _createClass(PostRelatedImage, [{
	        key: 'render',
	        value: function render() {
	            return _react2.default.createElement(
	                'a',
	                { href: "/post/" + this.props.post._id },
	                _react2.default.createElement('img', {
	                    className: 'img-link',
	                    src: _global2.default.formatImg(this.props.post.image, 'small') })
	            );
	        }
	    }]);

	    return PostRelatedImage;
	}(_react2.default.Component);

	exports.default = PostRelatedImage;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostRelatedTags = function (_React$Component) {
		_inherits(PostRelatedTags, _React$Component);

		function PostRelatedTags(props) {
			_classCallCheck(this, PostRelatedTags);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PostRelatedTags).call(this, props));

			_this.state = {
				tags: {},
				selectedTag: _this.props.tags ? _this.props.tags[0] : null
			};

			_this.getTags = _this.getTags.bind(_this);
			_this.setDisplayedTag = _this.setDisplayedTag.bind(_this);
			return _this;
		}

		_createClass(PostRelatedTags, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				this.getTags();
			}
	   ...
	   */
				...
				try {
					var _loop = function _loop() {
						...
						$.get('/api/gallery/search', {
							...
							if (!response.err && response.data) {
								_this2.state.tags[tag] = response.data;
								_this2.setState(_this2.state);
							}
						});
					};

					for (var _iterator = this.props.tags[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						_loop();
					}
				} catch (err) {
					_didIteratorError = true;
			...
			key: 'setDisplayedTag',
			value: function setDisplayedTag(event) {
			...
			value: function render() {
				...
				try {
					for (var _iterator2 = this.props.tags[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
						var _tag = _step2.value;

						if (!this.state.tags[_tag]) {
							break;
						}

						console.log(_tag);

						var posts = this.state.tags[_tag].map(function (post, i) {
							return _react2.default.createElement(_postRelatedImage2.default, { post: post, key: i });
						}),
						    toggled = _tag === this.state.selectedTag ? 'toggled' : '';

						var tab = _react2.default.createElement(
							'div',
							{ className: "tab " + toggled, key: _tag },
							_react2.default.createElement(
								'div',
								{ className: 'tab-inner' },
								_react2.default.createElement(
									'a',
									{ className: 'btn btn-flat', href: "/search?q=&tags[]=" + _tag },
									'See all'
								),
								posts
							)
						...
						var tabControl = _react2.default.createElement(
							'button',
							{
								className: "btn btn-flat " + toggled,
								key: _tag,
		...
		return PostRelatedTags;
	}(_react2.default.Component);

	exports.default = PostRelatedTags;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PostDetailImage = function (_React$Component) {
		_inherits(PostDetailImage, _React$Component);

		function PostDetailImage(props) {
			_classCallCheck(this, PostDetailImage);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PostDetailImage).call(this, props));

			_this.state = {
				purchased: _this.props.purchases && _this.props.purchases.indexOf(_this.props.post._id) >= 0
			};
		...
		_createClass(PostDetailImage, [{
			key: 'didPurchase',
			value: function didPurchase() {
				this.setState({
					purchased: true
				});
			}
	   ...
	   */
			...
			value: function render() {
				...
				var downloadAction = _react2.default.createElement(_downloadAction2.default, { post: this.props.post, key: i++ });

				var purchaseAction = _react2.default.createElement(_purchaseAction2.default, {
				...
				if (this.props.post.video) {
					postMedia = _react2.default.createElement(
						'video',
						{ width: '100%', height: '100%', controls: true, onContextMenu: this.contextMenu },
						_react2.default.createElement('source', { src: _global2.default.formatVideo(this.props.post.video), type: 'video/mp4' }),
						'Your browser does not support the video tag.'
					);
				} else {

					postMedia = _react2.default.createElement('img', {
						className: 'img-responsive',
						onContextMenu: this.contextMenu,
						src: _global2.default.formatImg(this.props.post.image, 'large') });
				}
		...
		return PostDetailImage;
	}(_react2.default.Component);

	exports.default = PostDetailImage;
