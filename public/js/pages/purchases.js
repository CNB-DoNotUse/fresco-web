...
/***/ function(module, exports, __webpack_require__) {
	...
	var Purchases = function (_React$Component) {
		_inherits(Purchases, _React$Component);

		function Purchases(props) {
			_classCallCheck(this, Purchases);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Purchases).call(this, props));
			...
			_this.findOutlets = _this.findOutlets.bind(_this);
			_this.addOutlet = _this.addOutlet.bind(_this);
			_this.removeOutlet = _this.removeOutlet.bind(_this);
			_this.loadStats = _this.loadStats.bind(_this);
			_this.loadPurchases = _this.loadPurchases.bind(_this);
			_this.downloadExports = _this.downloadExports.bind(_this);
			return _this;
		}
		...
		_createClass(Purchases, [{
			...
			key: 'findOutlets',
			value: function findOutlets(query) {
				var _this2 = this;
				...
				if (query.length == 0) {
					...
					$.get('/api/outlet/list?q=' + query, function (response) {
	   ...
	   */
			...
			key: 'addOutlet',
			value: function addOutlet(outletToAdd) {
				var availableOutlets = _lodash2.default.clone(this.state.availableOutlets, true),
				    outlets = _lodash2.default.clone(this.state.outlets, true),
				    outlet = null,
				    outletExists = false;
	   ...
	   */
			...
			key: 'removeOutlet',
			value: function removeOutlet(outletToRemove) {
				var outlets = _lodash2.default.clone(this.state.outlets, true),
				    filterIdsArr = [];
	   ...
	   */
			...
			value: function loadStats(callback) {
				$.get('/api/outlet/purchases/stats', {
					outlets: this.state.outlets.map(function (p) {
						return p._id;
					})
				}, function (response) {
					if (response.err || !response.data) {
	   ...
	   */
			...
			key: 'downloadExports',
			value: function downloadExports(format) {
				var filterOutletText = this.state.outlets.map(function (outlet) {
			...
			key: 'render',
			value: function render() {
				var outlets = this.state.outlets.map(function (outlet) {
					return outlet.title;
				});

				var availableOutlets = this.state.availableOutlets.map(function (outlet) {
					return outlet.title;
				});
	...
	_reactDom2.default.render(_react2.default.createElement(Purchases, {
