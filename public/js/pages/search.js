		...
		_createClass(TagFilter, [{
			...
			value: function render() {
				...
				for (var t in tagList) {
					available.push(_react2.default.createElement(_tag2.default, {
						onClick: this.props.onTagAdd.bind(null, tagList[t]),
						text: tagList[t], key: t }));
				}

				for (var t in filterList) {
					tags.push(_react2.default.createElement(_tag2.default, {
				...
				var dropdownButton = _react2.default.createElement(
					'div',
					{ className: 'toggle', ref: 'toggle_button', onClick: this.toggle },
					_react2.default.createElement(
						'span',
						null,
						dropdownLabel
					),
					_react2.default.createElement('span', { className: 'mdi mdi-menu-down', ref: 'menu-icon' })
				);

				var availableBody = '';
				if (available.length) {
					availableBody = _react2.default.createElement(
						'div',
						{ className: 'split-cell' },
						_react2.default.createElement(
							'span',
				...
				return _react2.default.createElement(
					_dropdown2.default,
					{ inList: true, title: dropdownLabel, dropdownClass: "tags-dropdown" },
					_react2.default.createElement(
						'div',
						{ className: 'chips' },
						_react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _locationDropdown = __webpack_require__(393);

	var _locationDropdown2 = _interopRequireDefault(_locationDropdown);

	var _tagFilter = __webpack_require__(391);

	var _tagFilter2 = _interopRequireDefault(_tagFilter);

	var _searchSidebar = __webpack_require__(394);
	...
	var Search = exports.Search = function (_React$Component) {
		...
		function Search(props) {
			...
			_this.getAssignments = _this.getAssignments.bind(_this);
			...
			_this.computeInitialState = _this.computeInitialState.bind(_this);
	  ...
	  */
		...
		_createClass(Search, [{
			...
			value: function computeInitialState() {
				...
				if (location.radius && location.coordinates) {
					var circle = new google.maps.Circle({
						...
						map: null,
						radius: _global2.default.feetToMiles(location.radius)
					});
			...
			value: function componentWillMount() {
				...
				if (this.state.location.coordinates) {
					...
					geocoder.geocode({ 'location': this.state.location.coordinates }, function (results, status) {
			...
			key: 'getTitle',
			value: function getTitle(withProps) {
	   ...
	   */
			...
			key: 'refreshData',
			value: function refreshData(initial) {
	   ...
	   */
			...
			key: 'getAssignments',
			value: function getAssignments(offset) {
				var _this3 = this;
				...
				var location = this.state.location,
					...
					radius: location.radius ? _global2.default.feetToMiles(location.radius) : undefined
				};

				$.get('/api/assignment/search', params, function (response, err) {
					if (!response.err && response.data && response.data.length > 0) {
						var assignments = force ? response.data : _this3.state.assignments.concat(response.data);
	   ...
	   */
			...
			value: function getPosts() {
				...
				var params = {
				    ...
				    location = _lodash2.default.clone(this.state.location);

				if (location.coordinates && location.radius) {
					params.polygon = _global2.default.circleToPolygon(location.coordinates, _global2.default.feetToMeters(location.radius), 16);
				}

				$.get('/api/gallery/search', params, function (response) {
					...
					if (!response.err && response.data) {
						...
						if (force) {
							...
							_this4.refs.postList.refs.grid.scrollTop = 0;
							posts = response.data;
							offset = response.data.length;
						} else {
							posts = _this4.state.posts.concat(response.data);
							offset = _this4.state.offset + response.data.length;
						}
			...
			value: function getUsers() {
				...
				$.get('/api/user/search', {
					...
					if (!response.err && response.data && response.data.length > 0) {
						...
						var users = force ? response.data : _this5.state.users.concat(response.data),
						    userOffset = force ? response.data.length : _this5.state.userOffset + response.data.length;
	   ...
	   */
			...
			key: 'getStories',
			value: function getStories(offset) {
				var _this6 = this;
				...
				$.ajax({
					...
					success: function success(response, status, xhr) {
						if (!response.err && response.data && response.data.length > 0) {
							var stories = force ? response.data : _this6.state.stories.concat(response.data);
	   ...
	   */
			...
			value: function onRadiusUpdate(radius) {
				var location = _lodash2.default.clone(this.state.location);
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_tagFilter2.default, {
							onTagAdd: this.addTag,
							onTagRemove: this.removeTag,
							filterList: this.state.tags,
							key: 'tagFilter'
						}),
						_react2.default.createElement(_locationDropdown2.default, {
	...
	_reactDom2.default.render(_react2.default.createElement(Search, {
		user: window.__initialProps__.user,
		purchases: window.__initialProps__.purchases || [],
		location: window.__initialProps__.location,
		tags: window.__initialProps__.tags,
		query: window.__initialProps__.query }), document.getElementById('app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LocationDropdown = function (_React$Component) {
		...
		function LocationDropdown(props) {
			...
			_this.onToggled = _this.onToggled.bind(_this);
			return _this;
		}

		_createClass(LocationDropdown, [{
			key: 'onToggled',
			value: function onToggled() {
				this.setState({
			...
			key: 'render',
			value: function render() {
				var dropdownBody = _react2.default.createElement(_autocompleteMap2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchSide = function (_React$Component) {
		_inherits(SearchSide, _React$Component);

		function SearchSide() {
			_classCallCheck(this, SearchSide);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(SearchSide).apply(this, arguments));
		}
		...
		_createClass(SearchSide, [{
			...
			value: function render() {
				...
				var assignments = this.props.assignments.map(function (assignment, i) {
					return _react2.default.createElement(
						"li",
						{ key: i },
						_react2.default.createElement(
					...
					return _react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								"span",
								{ className: "md-type-body1" },
								user.twitter ? '' : 'No Twitter',
								" • ",
								user.outlet ? _react2.default.createElement(
									"a",
									{ href: "/outlet/" + user._id },
									"Outlet"
								) : 'No Outlet'
							)
						)
				...
				return _react2.default.createElement(
					"div",
					{ className: "col-md-4 search-sidebar", onScroll: this.props.scroll },
					_react2.default.createElement(
						"h3",
					...
					_react2.default.createElement(
						"ul",
						{ id: "assignments", className: "md-type-subhead" },
						assignments
					),
					_react2.default.createElement(
						"h3",
					...
					_react2.default.createElement(
						"ul",
						{ id: "stories", className: "md-type-subhead" },
						stories
					),
					_react2.default.createElement(
						"h3",
