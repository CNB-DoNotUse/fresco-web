...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignmentSidebar = __webpack_require__(339);

	var _assignmentSidebar2 = _interopRequireDefault(_assignmentSidebar);

	var _assignmentEdit = __webpack_require__(340);
	...
	var AssignmentDetail = function (_React$Component) {
	  ...
	  function AssignmentDetail(props) {
	    ...
	    _this.state = {
	      ...
	      stats: _this.props.assignment.stats,
	      toggled: false,
	      verifiedToggle: true
	    };
	  ...
	  _createClass(AssignmentDetail, [{
	    ...
	    value: function expireAssignment() {
	      ...
	      $.post('/api/assignment/update', {
	        ...
	        if (response.err || !response.data) {
	          $.snackbar({ content: _global2.default.resolveError(response.err, 'There was an error expiring this assignment!') });
	        } else {
	    ...
	    value: function onVerifiedToggled(toggled) {
	      this.setState({
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_topbar2.default, {
	          ...
	          verifiedToggle: this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER /* Based on user rank to see verified content */
	          , editable: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentSidebar = function (_React$Component) {
		_inherits(AssignmentSidebar, _React$Component);

		function AssignmentSidebar() {
			_classCallCheck(this, AssignmentSidebar);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentSidebar).apply(this, arguments));
		}

		_createClass(AssignmentSidebar, [{
			key: 'render',
			value: function render() {
				...
				if (this.props.assignment.expiration_time > Date.now()) {
					...
					expireButton = _react2.default.createElement(
						'button',
						{
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(AssignmentStats, {
	...
	exports.default = AssignmentSidebar;

	var AssignmentStats = function (_React$Component2) {
		_inherits(AssignmentStats, _React$Component2);

		function AssignmentStats() {
			_classCallCheck(this, AssignmentStats);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentStats).apply(this, arguments));
		}

		_createClass(AssignmentStats, [{
			key: 'render',
			value: function render() {
				...
				var assignment = this.props.assignment,
				    ...
				    createdText = 'Created at ' + (0, _moment2.default)(assignment.time_created).format('LT'),
				    stats = this.props.stats;
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement('span', { className: 'mdi mdi-map-marker icon' }),
							_react2.default.createElement(
								'span',
								null,
								assignment.location && assignment.location.address || 'No Address'
							)
						),
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement('span', { className: 'mdi mdi-clock icon' }),
							_react2.default.createElement(
								'span',
								null,
								createdText
						...
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement('span', { className: 'mdi mdi-account icon' }),
							_react2.default.createElement(
								'span',
								null,
								assignment.outlet.title
							)
						),
						_react2.default.createElement(
							'li',
							null,
							_react2.default.createElement('span', { className: 'mdi mdi-image icon' }),
							_react2.default.createElement(
								'span',
								null,
								stats.photos + ' photo' + (_global2.default.isPlural(stats.photos) ? 's' : '')
							)
						),
						_react2.default.createElement(
							'li',
							...
							_react2.default.createElement(
								'span',
								null,
								stats.videos + ' video' + (_global2.default.isPlural(stats.videos) ? 's' : '')
							)
						)
					)
				);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _assignmentEditStats = __webpack_require__(341);

	var _assignmentEditStats2 = _interopRequireDefault(_assignmentEditStats);

	var _assignmentEditMap = __webpack_require__(342);

	var _assignmentEditMap2 = _interopRequireDefault(_assignmentEditMap);

	var _assignmentEditOutlet = __webpack_require__(343);

	var _assignmentEditOutlet2 = _interopRequireDefault(_assignmentEditOutlet);
	...
	var AssignmentEdit = function (_React$Component) {
		_inherits(AssignmentEdit, _React$Component);

		function AssignmentEdit(props) {
			_classCallCheck(this, AssignmentEdit);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentEdit).call(this, props));

			_this.state = {
				location: {
					lat: _this.props.assignment.location.geo.coordinates[1],
					lng: _this.props.assignment.location.geo.coordinates[0]
				},
				radius: _global2.default.milesToFeet(_this.props.assignment.location.radius),
				address: _this.props.assignment.location.address,
				outlet: _this.props.assignment.outlet
			};

			_this.onPlaceChange = _this.onPlaceChange.bind(_this);
			_this.onMapDataChange = _this.onMapDataChange.bind(_this);
			_this.updateRadius = _this.updateRadius.bind(_this);
		...
		_createClass(AssignmentEdit, [{
			...
			value: function revert() {
				...
				this.setState({
					...
					radius: _global2.default.milesToFeet(this.props.assignment.location.radius),
			...
			key: 'updateOutlet',
			value: function updateOutlet(outletId) {
				this.setState({
					outlet: outletId
				});
			}
	   ...
	   */
			...
			key: 'onMapDataChange',
			value: function onMapDataChange(data) {
				var _this2 = this;
	   ...
	   */
			...
			value: function save() {
				...
				var params = {
					...
					radius: _global2.default.feetToMiles(this.state.radius),
				...
				$.post('/api/assignment/update', params, function (response) {
					if (response.err) {
						$.snackbar({
						...
						_this3.props.setAssignment(response.data);
						_this3.props.toggle();
					}
				});
			}
	   ...
	   */
			...
			value: function render() {
				...
				if (this.props.user.rank >= _global2.default.RANKS.CONTENT_MANAGER) {
					assignmentEditOutlet = _react2.default.createElement(_assignmentEditOutlet2.default, {
				...
				return _react2.default.createElement(
					'div',
					null,
					_react2.default.createElement('div', { className: "dim toggle-edit " + toggledText }),
					_react2.default.createElement(
						'div',
						{ className: "edit panel panel-default toggle-edit" + toggledText },
						_react2.default.createElement(_assignmentEditStats2.default, {
							stats: this.props.stats,
							assignment: this.props.assignment }),
						_react2.default.createElement(
							'div',
							{ className: 'col-xs-12 col-lg-9 edit-new dialog' },
							_react2.default.createElement(
								'div',
								{ className: 'dialog-head' },
								_react2.default.createElement(
								...
								_react2.default.createElement('span', { className: 'mdi mdi-close pull-right icon toggle-edit toggler', onClick: this.cancel })
							),
							_react2.default.createElement(
								'div',
								{ className: 'dialog-foot' },
									...
									_react2.default.createElement(
										...
										_react2.default.createElement(
											...
											_react2.default.createElement('input', {
												...
												defaultValue: _global2.default.hoursToExpiration(this.props.assignment.expiration_time) })
										)
									)
								)
							)
	...
	exports.default = AssignmentEdit;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentEditStats = function (_React$Component) {
		_inherits(AssignmentEditStats, _React$Component);

		function AssignmentEditStats(props) {
			_classCallCheck(this, AssignmentEditStats);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentEditStats).call(this, props));
		}

		_createClass(AssignmentEditStats, [{
			key: 'render',
			value: function render() {

				var assignment = this.props.assignment,
				    address = assignment.location && assignment.location.address ? assignment.location.address : 'No Address',
				    timeCreated = (0, _moment2.default)(new Date(assignment.time_created)).format('MMM Do YYYY, h:mm:ss a'),
				    expirationTime = new Date(this.props.assignment.expiration_time),
				    expiresText = ((0, _moment2.default)().diff(expirationTime) > 1 ? 'Expired ' : 'Expires ') + (0, _moment2.default)(expirationTime).fromNow();

				return _react2.default.createElement(
					'div',
					{ className: 'col-lg-3 visible-lg edit-current' },
					_react2.default.createElement(
						'div',
						{ className: 'meta' },
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								null,
								_react2.default.createElement('img', { className: 'img-circle img-responsive', src: '/images/placeholder-assignment@2x.png' })
							),
							_react2.default.createElement(
								'div',
								null,
								...
								_react2.default.createElement(
									'span',
									{ id: 'assignment-edit-owner', className: 'md-type-body1' },
									'Posted by ',
									assignment.outlet.title
								)
							)
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									'li',
									null,
									_react2.default.createElement('span', { className: 'mdi mdi-alert-circle icon' }),
									expiresText
								)
							)
						)
		...
		return AssignmentEditStats;
	}(_react2.default.Component);

	exports.default = AssignmentEditStats;
...
/***/ function(module, exports, __webpack_require__) {
	...
	**/
	...
	var AssignmentEditMap = function (_React$Component) {
		_inherits(AssignmentEditMap, _React$Component);

		function AssignmentEditMap(props) {
			_classCallCheck(this, AssignmentEditMap);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentEditMap).call(this, props));

			_this.updateRadius = _this.updateRadius.bind(_this);
			return _this;
		}

		_createClass(AssignmentEditMap, [{
			key: 'componentDidMount',
			value: function componentDidMount() {
				var _this2 = this;
				...
				google.maps.event.addListener(autocomplete, 'place_changed', function () {
					...
					_this2.props.updateLocation(location, _this2.props.radius, _this2.refs.autocomplete.value);
				});
			}
	   ...
	   */
			...
			key: 'updateRadius',
			value: function updateRadius(e) {

				var feetRadius = parseInt(this.refs['radius'].value, 10);

				if (feetRadius == 'NaN') return;

				this.props.updateLocation(this.props.location, feetRadius);
			}
		}, {
			key: 'render',
			value: function render() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var AssignmentEditOutlet = function (_React$Component) {
		_inherits(AssignmentEditOutlet, _React$Component);

		function AssignmentEditOutlet(props) {
			_classCallCheck(this, AssignmentEditOutlet);

			var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AssignmentEditOutlet).call(this, props));

			_this.state = {
				suggestions: []
			};
			_this.change = _this.change.bind(_this);
			_this.addOutlet = _this.addOutlet.bind(_this);
			return _this;
		}

		_createClass(AssignmentEditOutlet, [{
			key: 'change',
			value: function change(e) {
				var _this2 = this;
				...
				if (query.length == 0) {
					...
					$.ajax({
						...
						data: { q: query },
						success: function success(result, status, xhr) {
							if (result.data) _this2.setState({ suggestions: result.data });
						}
					});
				}
			}
	   ...
	   */
			...
			key: 'addOutlet',
			value: function addOutlet(outlet) {
			...
			value: function render() {
				...
				if (this.props.outlet) {
					outlet = _react2.default.createElement(_tag2.default, {
				...
				//Map suggestions for dropdown
				var suggestions = this.state.suggestions.map(function (outlet, i) {

					return _react2.default.createElement(
						'li',
						{ onClick: _this3.addOutlet.bind(null, outlet),
							key: i },
						outlet.title
					);
				});
		...
		return AssignmentEditOutlet;
	}(_react2.default.Component);

	exports.default = AssignmentEditOutlet;
