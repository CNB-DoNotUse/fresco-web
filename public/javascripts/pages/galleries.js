...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    ...
	    GalleryList = __webpack_require__(159),
	    TopBar = __webpack_require__(161);
	...
	var Galleries = React.createClass({
		...
		render: function () {
			return React.createElement(
				...
				React.createElement(GalleryList, { half: true, withList: false })
			);
		}
	});
	...
	ReactDOM.render(React.createElement(Galleries, null), document.getElementById('page'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	ReactDOM = __webpack_require__(158), SuggestionList = __webpack_require__(160);
	...
	var GalleryList = React.createClass({
		...
		loadGalleries: function (passedOffset, callback) {
			...
			if (this.props.highlighted) $.ajax({
		...
		render: function () {
			...
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						'span',
						{ className: 'time-display-filter-text' },
						'Relative'
					),
